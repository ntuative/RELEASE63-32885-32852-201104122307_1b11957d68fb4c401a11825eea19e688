package com.sulake.room
{
   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      {
         if(this.var_1369.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
      ...
      {
         if(this.var_1368.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
         ...
         if(this.var_605[param1] != param2)
         {
            this.var_605[param1] = param2;
         }
      }
      ...
      public function update() : void
      {
         ...
         var _loc2_:int = this.var_604.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = int(this.var_604[_loc2_]);
