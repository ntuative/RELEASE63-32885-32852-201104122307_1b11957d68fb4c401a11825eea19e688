package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_686:Number = 64;
      ...
      private var var_1955:Vector3d;
      
      private var var_545:Vector3d;
      
      private var _direction:Vector3d;
      
      private var var_1249:Vector3d;
      ...
      private var var_1958:Number = 1.0;
      
      private var var_1956:Number = 1.0;
      
      private var var_1957:Number = 1.0;
      
      private var var_95:Vector3d;
      
      private var var_385:Vector3d;
      
      private var var_2928:Number = -500.0;
      
      private var var_2927:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1249 = new Vector3d();
         this.var_1958 = 1;
         this.var_1956 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1957 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_1955.assign(this.var_155);
         return this.var_1955;
      }
      
      public function get location() : IVector3d
      {
         this.var_545.assign(this.var_95);
         this.var_545.x *= this.var_459;
         this.var_545.y *= this.var_460;
         this.var_545.z *= this.var_458;
         return this.var_545;
      }
      
      public function get direction() : IVector3d
      {
         this._direction.assign(this.var_385);
         return this._direction;
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_459 != param1 * this.var_1958)
         {
            this.var_459 = param1 * this.var_1958;
            ++this.var_169;
         }
      }
      ...
      {
         if(this.var_460 != param1 * this.var_1956)
         {
            this.var_460 = param1 * this.var_1956;
            ++this.var_169;
         }
      }
      ...
      {
         if(this.var_458 != param1 * this.var_1957)
         {
            this.var_458 = param1 * this.var_1957;
            ++this.var_169;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_95.x /= this.var_459;
         this.var_95.y /= this.var_460;
         this.var_95.z /= this.var_458;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_385.x;
         var _loc3_:Number = this.var_385.y;
         var _loc4_:Number = this.var_385.z;
         this.var_385.assign(param1);
         if(this.var_385.x != _loc2_ || this.var_385.y != _loc3_ || this.var_385.z != _loc4_)
         {
            ++this.var_169;
         }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1249.assign(_loc22_);
         }
         else
         {
            this.var_1249.assign(_loc17_);
         }
         ++this.var_169;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1249);
         if(_loc3_ < this.var_2928 || _loc3_ > this.var_2927)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_460;
            _loc2_.z *= this.var_458;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1249);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         _loc7_.add(Vector3d.product(this.var_154,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_95.x * this.var_459,this.var_95.y * this.var_460,this.var_95.z * this.var_458);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_155;
      ...
      public function performZoom() : void
      {
         ...
         {
            this.scale = const_686;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_686;
      }
