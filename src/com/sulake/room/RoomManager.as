package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_1685:int = 0;
      ...
      private var var_2942:IRoomContentLoader;
      
      private var var_633:IRoomObjectFactory = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_632 = [];
         this.var_604 = [];
         events.addEventListener(RoomContentLoadedEvent.const_393,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_502,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_872,this.onContentLoaded);
      }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_633 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_633 == null || this.var_509 == null)
         {
            return;
         }
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_632.indexOf(_loc5_) < 0)
            {
               this.var_55.loadObjectContent(_loc5_,events);
               this.var_632.push(_loc5_);
            }
            _loc4_++;
         }
         this._state = const_1262;
         return true;
      }
      ...
      {
         var _loc4_:* = null;
         var _loc2_:int = this.var_604.indexOf(param1);
         if(_loc2_ >= 0)
         {
            return;
         }
         this.var_604.push(param1);
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_604.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_604[_loc4_];
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_509.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_509.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_633.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_633 != null)
         {
            return this.var_633.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this.var_55.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_632.indexOf(param1);
            if(_loc2_ >= 0)
            {
               this.var_632.splice(_loc2_,1);
            }
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         while(this.var_956.length > 0)
         {
            _loc2_ = this.var_956[0];
            this.var_956.splice(0,1);
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_55 == null || this.var_509 == null)
         {
            return;
         }
         ...
         var _loc7_:IRoomObjectVisualizationData = this.var_509.getRoomObjectVisualizationData(param1,_loc5_,_loc2_);
            ...
            if(_loc9_ != null)
            {
               ...
               for each(_loc12_ in _loc11_)
               {
                  ...
                  while(_loc14_ >= 0)
                  {
                     ...
                     if(_loc15_ != null)
                     {
                        _loc16_ = this.var_509.createRoomObjectVisualization(_loc5_);
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_633.createRoomObjectLogic(_loc6_);
