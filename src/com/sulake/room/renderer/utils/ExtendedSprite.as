package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      private var var_1501:int = 128;
      
      private var var_1502:Boolean = false;
      
      private var var_2918:Point;
      ...
      {
         if(param1 != this.var_1893 || param2 != this.var_1892)
         {
      ...
      {
         if(this.var_1501 > 255 || bitmapData == null)
         {
            return false;
         }
         if(param1 < 0 || param2 < 0 || param1 >= this.var_263 || param2 >= this._height)
         {
            return false;
         }
