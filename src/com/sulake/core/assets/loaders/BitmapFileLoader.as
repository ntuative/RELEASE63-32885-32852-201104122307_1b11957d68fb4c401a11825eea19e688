package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      protected var var_1066:LoaderContext;
      
      public function BitmapFileLoader(param1:String, param2:URLRequest = null)
      {
         super();
         this.var_1065 = param2 == null ? "" : param2.url;
         this._type = param1;
         this.var_43 = new Loader();
         this.var_1066 = new LoaderContext();
         this.var_1066.checkPolicyFile = true;
         ...
         {
            this.var_43.load(param2,this.var_1066);
         }
      }
      ...
      {
         this.var_1065 = param1.url;
         var_332 = 0;
         this.var_43.load(param1,this.var_1066);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_332 < var_2891)
            {
               ...
               this.var_43.load(new URLRequest(this.var_1065 + (this.var_1065.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_332),this.var_1066);
               return true;
            }
         }
         return false;
