package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1497:String = "AssetLibraryUnloaded";
      
      public static const const_1667:String = "AssetLibraryLoadError";
      
      private static const const_438:String = "name";
      
      private static const const_1026:String = "asset";
      
      private static const const_1028:String = "param";
      
      private static const TYPE:String = "mimeType";
      
      private static const const_1027:String = "library";
      
      private static var var_328:Dictionary;
      
      private static var var_2000:LazyAssetProcessor = new LazyAssetProcessor();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_557;
         this.var_463 = new Dictionary(false);
         this.var_556 = new Dictionary(false);
         this.var_1036 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_680 + " doesn\'t contain valid resource class!");
         }
         ...
         if(_loc5_ != null)
         {
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1028);
                  if(_loc11_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_680 + "!");
               }
               _loc15_++;
            }
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_1035.splice(var_1035.indexOf(this),1);
            --var_557;
            this.var_556 = null;
            this.var_1036 = null;
            this.var_171 = null;
      ...
      {
         if(this.var_680 == param1.url && this.var_1037)
         {
            if(!this.var_1038 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_679);
            }
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in this.var_556)
         {
            _loc2_ = this.var_556[_loc1_];
            _loc2_.assetLoader.dispose();
            delete this.var_556[_loc1_];
         }
         for(_loc1_ in this.var_171)
         {
            delete this.var_171[_loc1_];
         }
         for(_loc1_ in this.var_1036)
         {
            delete this.var_1036[_loc1_];
         }
         if(this.var_43 != null)
         {
            this.var_43.dispose();
         ...
         this.var_1037 = false;
         this.var_680 = null;
         dispatchEvent(new Event(AssetLibrary.const_1497));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_1036[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_556[param2.url];
         if(_loc4_ != null)
         {
         ...
         this.var_556[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_556[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_30:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_464;
                     this.var_465.push(struct.assetName);
                  }
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_556[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return param1 < this.var_465.length ? this.getAssetByName(this.var_465[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_171)
         {
            ...
            {
               return this.var_465.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_171[param1] != null || (this.var_679 != null ? this.var_679[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_2000.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_171)
            {
               if(this.var_171[_loc2_] == param1)
               {
                  this.var_465.splice(this.var_465.indexOf(_loc2_),1);
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_328.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_328[param1.mimeType] = param1;
         }
         else
         {
            if(this.var_463.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_463[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_328[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
         }
         return AssetTypeDeclaration(this.var_463[param1]);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_328)
            {
               _loc3_ = AssetTypeDeclaration(var_328[_loc4_]);
               if(_loc3_ != null)
               {
         ...
         for(_loc4_ in this.var_463)
         {
            _loc3_ = AssetTypeDeclaration(this.var_463[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_328)
            {
               _loc4_ = AssetTypeDeclaration(var_328[_loc5_]);
               if(_loc4_ != null)
               {
         ...
         for(_loc5_ in this.var_463)
         {
            _loc4_ = AssetTypeDeclaration(this.var_463[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_679 = _loc2_.resource;
         this.var_680 = _loc2_.url;
         if(this.var_1038)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_679);
         }
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1667));
         this.var_43 = null;
      }
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc8_ < _loc7_)
            {
               ...
               if(_loc3_.attribute(const_438).toString() == param1)
               {
                  ...
                  if(_loc4_ == null)
                  {
                     throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_680 + "!");
                  }
                  _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                  _loc5_.setUnknownContent(this.var_679[param1]);
                  _loc6_ = _loc3_.child(const_1028);
                  if(_loc6_.length())
                  {
