package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      private var var_1797:AssetTypeDeclaration;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_540 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_107 is BitmapDataAsset)
         {
            ...
            this.var_1447 = BitmapDataAsset(this.var_107).var_1447;
            this.var_1446 = BitmapDataAsset(this.var_107).var_1446;
            if(this._bitmap != null)
            {
               this.var_107 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               ...
               case "flipH":
                  ...
                  break;
               case "flipV":
                  this.var_1446 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
