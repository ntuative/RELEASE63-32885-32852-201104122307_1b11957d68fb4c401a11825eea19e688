package com.sulake.core.utils
{
   ...
   public class FontEnum
   {
      ...
      private static const const_626:Map = new Map();
      
      private static const const_352:Map = new Map();
      
      private static var var_1133:Boolean = false;
      ...
      {
         return const_626.getValue(param1) != null;
      }
      ...
      private static function init() : void
      {
         ...
         if(!var_1133)
         {
            ...
            for each(_loc3_ in _loc1_)
            {
               ...
               {
                  const_626.add(_loc3_.fontName,_loc3_);
               }
            }
            var_1133 = true;
         }
