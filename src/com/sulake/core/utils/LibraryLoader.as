package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1768:uint = 1;
      
      protected static const const_1765:uint = 2;
      
      protected static const const_1766:uint = 4;
      
      protected static const const_1767:uint = 3;
      
      protected static const name_4:uint = 7;
      
      public static const const_1743:int = 5;
      
      public static const LIBRARY_LOADER_FINALIZE:String = "LIBRARY_LOADER_FINALIZE";
      
      public static const const_1087:Boolean = false;
      ...
      protected var var_2960:uint = 0;
      
      protected var var_2889:Boolean = true;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1087)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_804[_loc2_] as LibraryLoader;
               if(_loc1_ && (_loc1_.ready || _loc1_.disposed))
               {
                  var_804.splice(_loc2_,1);
               }
               _loc2_--;
            }
            while(var_804.length < const_1724 && false)
            {
               _loc1_ = var_992.shift() as LibraryLoader;
      ...
      {
         return !!this.var_1071 ? uint(this.var_1324 - this.var_2108) : uint(getTimer() - this.var_2108);
      }
      ...
      public function resume() : void
      {
         ...
         {
            this.var_1072 = false;
            if(!this.var_1071 && this.var_242)
            {
               this.var_1324 = -1;
               this.var_2108 = getTimer();
               queue(this);
            }
         }
      }
      ...
      protected function retry() : Boolean
      {
         if(!this.var_1071 && !_disposed && this.var_1323 > 0)
         {
            ...
            this.addRequestCounterToUrlRequest(this.var_242,const_1743 - this.var_1323);
            if(this.var_2889)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(this.var_478 == LibraryLoader.const_1767)
         {
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_679 = this.getDefinition(this._name) as Class;
         ...
         try
         {
            xmlClass = this.var_679.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
