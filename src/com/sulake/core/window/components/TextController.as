package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1269:Dictionary = createPropertySetterTable();
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_190);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_827 ? true : null;
         }
      ...
      {
         this.var_866 = param1;
         this._field.scrollH = this.var_866 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_866 * this.maxScrollH,this.var_566 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1131) ? new PropertyStruct(PropertyDefaults.const_653,this._field.antiAliasType,PropertyStruct.const_54,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1105) : PropertyDefaults.const_1597);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1251 ? new PropertyStruct(PropertyDefaults.const_889,this._autoSize,PropertyStruct.const_54,true,PropertyDefaults.const_1090) : PropertyDefaults.const_1708);
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1115 ? new PropertyStruct(PropertyDefaults.const_1075,this._field.gridFitType,PropertyStruct.const_54,true,PropertyDefaults.const_1114) : PropertyDefaults.const_1678);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_903) ? new PropertyStruct(PropertyDefaults.const_416,this._field.textColor,PropertyStruct.const_139,true) : PropertyDefaults.const_1103);
         _loc1_.push(this.var_419 != TextStyleManager.const_190 ? new PropertyStruct(PropertyDefaults.const_369,this.var_419,PropertyStruct.const_54,true,PropertyDefaults.const_910) : PropertyDefaults.const_1175);
         _loc1_.push(this.var_40.left != PropertyDefaults.const_926 ? new PropertyStruct(PropertyDefaults.const_256,this.var_40.left,PropertyStruct.const_42,true) : PropertyDefaults.const_548);
         _loc1_.push(this.var_40.top != PropertyDefaults.const_738 ? new PropertyStruct(PropertyDefaults.const_261,this.var_40.top,PropertyStruct.const_42,true) : PropertyDefaults.const_589);
         _loc1_.push(this.var_40.right != PropertyDefaults.const_925 ? new PropertyStruct(PropertyDefaults.const_259,this.var_40.right,PropertyStruct.const_42,true) : PropertyDefaults.const_546);
         _loc1_.push(this.var_40.bottom != PropertyDefaults.const_761 ? new PropertyStruct(PropertyDefaults.const_257,this.var_40.bottom,PropertyStruct.const_42,true) : PropertyDefaults.const_468);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1160 ? new PropertyStruct(PropertyDefaults.const_671,this._field.mouseWheelEnabled,PropertyStruct.const_39,true) : PropertyDefaults.const_1524);
