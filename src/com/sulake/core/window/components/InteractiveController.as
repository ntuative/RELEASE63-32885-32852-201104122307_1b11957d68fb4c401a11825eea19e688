package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         this.var_1594 = PropertyDefaults.const_857;
         this.var_1318 = PropertyDefaults.const_372;
         param4 |= 0;
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_372)
         {
      ...
      public static function readInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : void
      {
         ...
         for each(_loc3_ in param2)
         {
            switch(_loc3_.key)
            {
               case PropertyDefaults.const_660:
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_372)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_660,param1.toolTipCaption,PropertyStruct.const_54,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1558);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_857)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_794,param1.toolTipDelay,PropertyStruct.const_264,true));
         }
         else
         {
