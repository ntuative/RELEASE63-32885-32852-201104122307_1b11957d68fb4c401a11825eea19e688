package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      override public function dispose() : void
      {
         if(this.var_462)
         {
            this.var_462.removeEventListener(WindowEvent.const_280,this.scrollBarEventProc);
            this.var_462.removeEventListener(WindowEvent.const_187,this.scrollBarEventProc);
            this.var_462 = null;
         }
         if(this.var_1261)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1261)
         {
            this.var_1261 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_462)
         {
            ...
            if(this.var_462)
            {
               this.var_462.addEventListener(WindowEvent.const_280,this.scrollBarEventProc);
               this.var_462.addEventListener(WindowEvent.const_187,this.scrollBarEventProc);
            }
         }
         return this.var_462;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_187)
         {
            this.hideScrollBar();
         }
      }
