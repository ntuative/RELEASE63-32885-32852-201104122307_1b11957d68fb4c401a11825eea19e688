package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1456:String = "increment";
      
      private static const const_1457:String = "decrement";
      
      private static const const_1035:String = "slider_track";
      
      private static const const_650:String = "slider_bar";
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_174 = false;
         this.var_17 = param12;
         this._horizontal = param2 == WindowType.const_613;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_17 != null && !this.var_17.disposed)
         {
            ...
            this.var_17.removeEventListener(WindowEvent.const_523,this.onScrollableScrolled);
         }
         this.var_17 = param1;
         if(this.var_17 != null && !this.var_17.disposed)
         {
            this.var_17.addEventListener(WindowEvent.const_41,this.onScrollableResized);
            this.var_17.addEventListener(WindowEvent.const_523,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         else if(this.var_1049 != null)
         {
            _loc2_ = this.var_1049;
         }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_1049 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_1035) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_650) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_650:
         ...
         if(param2.type == WindowEvent.const_743)
         {
            if(this.var_17 == null)
            {
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_318)
            {
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_43 || param1.type == WindowTouchEvent.const_829)
         {
            ...
            else if(param2.name == const_1457)
            {
               if(this.var_17)
               {
                  this.var_1286 = true;
            ...
            else if(param2.name == const_1035)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_650).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
         ...
         if(param1.type == WindowMouseEvent.const_318)
         {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_1049) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_1049) as IScrollableWindow;
               if(_loc1_)
               {
