package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1334:String = "_TITLE";
      
      private static const const_1333:String = "_HEADER";
      
      private static const const_1331:String = "_CONTENT";
      ...
      private var var_1414:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1334) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1414 = findChildByTag(const_1333) as IHeaderWindow;
            if(!this.var_1414)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_184 = findChildByTag(const_1331) as IWindowContainer;
            if(!this.var_184)
            {
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1272,_loc2_,false);
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_326);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_239);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_272);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
            ...
            if(_loc4_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_272,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_272,false);
            }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_316,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_256,_loc3_.left,PropertyStruct.const_42,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_261,_loc3_.top,PropertyStruct.const_42,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_259,0 - _loc3_.right,PropertyStruct.const_42,_loc2_));
