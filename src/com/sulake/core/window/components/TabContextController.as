package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1290:String = "_SELECTOR";
      
      private static const const_1291:String = "_CONTENT";
       
      
      protected var var_1063:ITabSelectorWindow;
      
      protected var var_2096:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1063 = findChildByTag(const_1290) as ITabSelectorWindow;
            if(this.var_1063 != null)
            {
               this.var_1063.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2096 = findChildByTag(const_1291) as IWindowContainer;
         }
      ...
      {
         return !!this.var_726 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1063.numSelectables;
      }
