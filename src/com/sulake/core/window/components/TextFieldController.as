package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1325:Boolean = false;
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1053,var_11);
         }
         return var_21;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_726 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_407,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      private function onChangeEvent(param1:Event) : void
      {
         ...
         {
            this.refreshAutoSize();
            windowEvent = WindowEvent.allocate(WindowEvent.const_99,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_737,false,PropertyStruct.const_39,true) : PropertyDefaults.const_1500);
         _loc1_.push(this.var_1325 != PropertyDefaults.const_1261 ? new PropertyStruct(PropertyDefaults.const_945,this.var_1325,PropertyStruct.const_39,true) : PropertyDefaults.const_1542);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1059 ? new PropertyStruct(PropertyDefaults.const_693,_field.selectable,PropertyStruct.const_39,true) : PropertyDefaults.const_1698);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1162 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_39,true) : PropertyDefaults.const_1641);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_945:
                  this.var_1325 = _loc2_.value as Boolean;
                  if(this.var_1325)
                  {
