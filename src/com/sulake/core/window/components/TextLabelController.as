package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2623 = _loc2_.textWidth;
         this.var_2624 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_374 != _loc2_.color : this.var_374 != null && this.var_374 != PropertyDefaults.const_903) ? new PropertyStruct(PropertyDefaults.const_416,this.var_374,PropertyStruct.const_139,true) : PropertyDefaults.const_1103);
         if(this.var_40)
         {
            if(this.var_40.left != PropertyDefaults.const_926)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_256,this.var_40.left,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_548);
            }
            if(this.var_40.top != PropertyDefaults.const_738)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_261,this.var_40.top,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_589);
            }
            if(this.var_40.right != PropertyDefaults.const_925)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_259,this.var_40.right,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_546);
            }
            if(this.var_40.bottom != PropertyDefaults.const_761)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_257,this.var_40.bottom,PropertyStruct.const_42,true));
            }
            else
            {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_369:
