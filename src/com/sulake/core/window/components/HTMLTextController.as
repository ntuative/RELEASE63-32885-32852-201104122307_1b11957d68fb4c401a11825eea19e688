package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private var var_1281:String = null;
      
      private var var_2015:StyleSheet = null;
      ...
      {
         this.var_842 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1281 == param2)
         {
            return;
         }
         param1.var_1281 = param2;
         param1.var_2015 = null;
         if(param1.var_1281 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1281);
            param1.var_2015 = _loc3_;
         }
      }
      ...
      {
         return this.var_842 == LinkTarget.const_29 ? defaultLinkTarget : this.var_842;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_20);
            _field.styleSheet = this.var_2015;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1123)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_842 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_760,this.var_842,PropertyStruct.const_54,true,PropertyDefaults.const_938));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1745);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_760)
            {
               this.var_842 = _loc2_.value as String;
               break;
            }
