package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_96:String = "FollowFriendFailedMessageParser";
      
      public static const const_113:String = "active";
         ...
         if(_loc8_.length() > 0)
         {
            ...
            switch(_loc6_.toLowerCase())
            {
               case "fixed":
                  ...
                  break;
               case "move":
                  _loc5_.var_398 = SkinLayoutEntity.const_304;
                  break;
               case "strech":
                  _loc5_.var_398 = SkinLayoutEntity.const_535;
                  break;
               case "tiled":
                  _loc5_.var_398 = SkinLayoutEntity.const_343;
                  break;
               case "center":
                  _loc5_.var_398 = SkinLayoutEntity.const_1250;
            }
            ...
            switch(_loc6_.toLowerCase())
            {
               case "fixed":
                  ...
                  break;
               case "move":
                  _loc5_.var_396 = SkinLayoutEntity.const_304;
                  break;
               case "strech":
                  _loc5_.var_396 = SkinLayoutEntity.const_535;
                  break;
               case "tiled":
                  _loc5_.var_396 = SkinLayoutEntity.const_343;
                  break;
               case "center":
                  _loc5_.var_396 = SkinLayoutEntity.const_1250;
            }
         }
      ...
      protected static function parseState(param1:ISkinRenderer, param2:XML, param3:Dictionary, param4:Map) : void
      {
         ...
         switch(_loc5_)
         {
            case BitmapSkinParser.const_113:
               _loc10_ = 0;
               break;
