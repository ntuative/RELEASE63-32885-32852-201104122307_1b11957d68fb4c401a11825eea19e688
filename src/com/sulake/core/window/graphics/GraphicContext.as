package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1526:uint = 0;
      
      public static const const_855:uint = 1;
      
      public static const const_1053:uint = 2;
      
      public static const const_849:uint = 4;
      
      public static const const_1473:uint = 8;
      
      public static const const_1626:uint = 16;
      
      public static const const_1925:uint = 64;
      
      public static const const_1830:uint = 128;
      
      public static const const_1076:uint = 256;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            case GraphicContext.const_855:
               ...
               break;
            case GraphicContext.const_1053:
            ...
            case GraphicContext.const_1626:
               ...
               break;
            case GraphicContext.const_849:
               this.setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_1076:
               break;
            case GraphicContext.const_1526:
               break;
            default:
         ...
         if(this.var_873)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2114,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2114,16777215);
                  }
                  var_336 += bitmap.width * bitmap.height * 4;
               }
