   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            if(_loc16_)
            {
               this.var_848.redMultiplier = ((param1.color & 16711680) >> 16) / 255;
               this.var_848.greenMultiplier = ((param1.color & 65280) >> 8) / 255;
               this.var_848.blueMultiplier = (param1.color & 255) / 255;
            ...
            while(_loc17_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc16_ && _loc10_.colorize)
                  {
                     ...
                     _loc18_.colorTransform(_loc18_.rect,this.var_848);
                  }
                  _loc12_ = false;
                  _loc13_ = false;
                  ...
                  if(_loc10_.var_398 == SkinLayoutEntity.const_304)
                  {
                     var_29.x += _loc14_;
                  }
                  ...
                  else if(_loc10_.var_398 == SkinLayoutEntity.const_343)
                  {
                     _loc12_ = true;
                     var_29.right += _loc14_;
                     if(true)
                  ...
                  if(_loc10_.var_396 == SkinLayoutEntity.const_304)
                  {
                     var_29.y += _loc15_;
                  }
                  ...
                  else if(_loc10_.var_396 == SkinLayoutEntity.const_343)
                  {
                     _loc13_ = true;
                     var_29.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.var_396 == SkinLayoutEntity.const_343 || _loc10_.var_398 == SkinLayoutEntity.const_343)
                  {
                  ...
                  {
                     this.var_284.a = var_29.width;
                     this.var_284.d = var_29.height;
                     this.var_284.tx = var_29.x;
                     this.var_284.ty = var_29.y;
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:SkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.var_398 == SkinLayoutEntity.const_304)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.var_396 == SkinLayoutEntity.const_304)
               {
