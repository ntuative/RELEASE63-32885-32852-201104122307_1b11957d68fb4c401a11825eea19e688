package com.sulake.core.window.utils
{
   ...
   public class MouseCursorControl
   {
      ...
      private static var var_759:Boolean = true;
      
      private static var var_117:DisplayObject;
      
      private static var var_1418:Dictionary = new Dictionary();
         ...
         if(var_759)
         {
            ...
            else
            {
               ...
               switch(_type)
               {
                  ...
                  case MouseCursorType.const_265:
                  case MouseCursorType.const_1677:
                  case MouseCursorType.const_1525:
