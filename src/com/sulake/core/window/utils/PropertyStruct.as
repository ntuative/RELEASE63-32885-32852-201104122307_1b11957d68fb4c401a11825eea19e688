package com.sulake.core.window.utils
{
   ...
   public class PropertyStruct
   {
      ...
      public function PropertyStruct(param1:String, param2:Object, param3:String, param4:Boolean, param5:Array = null)
      {
         ...
         this.var_2919 = param3 == const_266 || param3 == const_156 || param3 == const_271 || param3 == const_267;
      ...
      public function toString() : String
      {
         switch(this._type)
         {
            ...
            case const_39:
               return Boolean(this.var_185) == true ? "true" : "false";
            case const_271:
      ...
      public function toXMLString() : String
      {
         ...
         switch(this._type)
         {
            case const_266:
               ...
               _loc1_ = "<var key=\"" + this.var_658 + "\">\r<value>\r<" + this._type + ">\r";
               _loc2_ = 0;
            ...
            case const_267:
               ...
               break;
            case const_139:
               _loc1_ = "<var key=\"" + this.var_658 + "\" value=\"" + "0x" + uint(this.var_185).toString(16) + "\" type=\"" + this._type + "\" />";
               break;
            default:
               _loc1_ = "<var key=\"" + this.var_658 + "\" value=\"" + this.var_185 + "\" type=\"" + this._type + "\" />";
         }
         return _loc1_;
      }
   }
