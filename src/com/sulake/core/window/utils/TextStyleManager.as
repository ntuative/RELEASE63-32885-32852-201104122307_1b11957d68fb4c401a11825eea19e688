package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_190:String = "regular";
      ...
      private static const const_651:String = "{";
      
      private static const const_652:String = "}";
      
      private static const const_1463:String = "/*";
      
      private static const const_1462:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_89[const_190],var_89[ITALIC],var_89[BOLD]];
            var_89.reset();
            var_89[const_190] = _loc5_[0];
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_652);
         if(countSubStrings(param1,const_651) != countSubStrings(param1,const_652))
         {
            throw new Error("Mismatching amount of \"" + const_651 + "\" versus \"" + const_652 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1463) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1462) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_651)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
