package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1046:String = "_EXCLUDE";
      
      public static const const_1832:String = "_INCLUDE";
      
      public static const const_1869:String = "_TEMP";
      
      private static const const_1304:String = "layout";
      
      private static const const_979:String = "window";
      
      private static const const_978:String = "variables";
      
      private static const const_980:String = "filters";
      
      private static const const_438:String = "name";
      
      private static const const_1309:String = "style";
      
      private static const const_623:String = "params";
      
      private static const const_1302:String = "tags";
      ...
      private static const const_1305:String = "visible";
      
      private static const const_1298:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_4:String = "background";
      
      private static const const_1056:String = "blend";
      
      private static const const_1299:String = "clipping";
      ...
      private static const const_1306:String = "width_min";
      ...
      private static const const_1307:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1313:Dictionary;
      
      protected var var_1312:Dictionary;
      
      protected var var_1064:Dictionary;
      
      protected var var_1589:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1313,this.var_1312);
         this.var_1064 = new Dictionary();
         this.var_1589 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1064,this.var_1589);
         this.var_2098 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1307,const_49);
         return param1.replace(const_1296,const_49);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1313)
            {
               delete this.var_1313[_loc1_];
            }
            for(_loc1_ in this.var_1312)
            {
               delete this.var_1312[_loc1_];
            }
            for(_loc1_ in this.var_1064)
            {
               delete this.var_1064[_loc1_];
            }
            for(_loc1_ in this.var_1589)
            {
               delete this.var_1589[_loc1_];
            }
            this.var_2098.dispose();
            this.var_2098 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1304)
         {
            ...
            _loc9_ = param1.child(const_980).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
               ...
               {
                  _loc12_.push(this.method_6(_loc9_[_loc13_]));
                  _loc13_++;
               }
               param2.filters = _loc12_;
            }
            _loc4_ = param1.child(const_979);
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1313[xml.localName()];
         ...
         params = uint(this.parseAttribute(xml,const_623,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1302,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_167));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_167));
         rect.width = Number(this.parseAttribute(xml,name_5,variables,const_167));
         rect.height = Number(this.parseAttribute(xml,name_1,variables,const_167));
         visible = this.parseAttribute(xml,const_1305,variables,visible.toString()) == const_624;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_623).length() > 0)
         {
            list = xml.child(const_623).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               ...
               if(this.var_1064[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_438)) + "\"!");
               }
               params |= this.var_1064[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_49) : const_49;
         caption = unescape(String(this.parseAttribute(xml,const_1298,variables,caption)));
         if(tag != const_49)
         {
            tags = tag.split(const_1300);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window.limits.minWidth = int(this.parseAttribute(xml,const_1306,variables,window.limits.minWidth));
         ...
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_624;
         blend = Number(this.parseAttribute(xml,const_1056,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1299,variables,window.clipping.toString()) == const_624;
         ...
         list = xml.child(const_980).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
            ...
            while(i < length)
            {
               filters.push(this.method_6(list[i]));
               i++;
            }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_49;
         var _loc3_:String = this.var_1312[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1046) == -1)
                  {
      ...
      private function method_6(param1:XML) : BitmapFilter
      {
         var _loc3_:* = null;
