package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1553:int = 2;
      ...
      private var var_1965:TriggerConfs;
      
      private var var_1963:ActionTypes;
      
      private var var_1964:ConditionTypes;
      ...
      private var var_1255:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1965 = new TriggerConfs();
         this.var_1963 = new ActionTypes();
         this.var_1964 = new ConditionTypes();
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1255 = new SliderWindowController(this.var_82,IWindowContainer(this.find(this.var_52,"delay_slider_container")),this.var_82.assets,0,20,1);
         this.var_1255.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1255.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_828.hideAll(this.var_278);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_828.showAll(this.var_278);
         if(this.var_37 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_37);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1255.setValue(_loc6_);
         }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1255.getValue()) : 0;
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = this.var_37.stuffTypeSelectionCode < 1 ? int(var_1553) : int(this.var_37.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = (this.var_37.stuffTypeSelectionCode + 1) % (var_1553 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1965);
         this.refreshConfigureElement(this.var_1963);
         this.refreshConfigureElement(this.var_1964);
