package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_2008 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1277 = this.var_2008.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1277)
         {
            this.var_1277.procedure = this.onButtonClick;
         }
         this.var_1278 = this.var_2008.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1278)
         {
      ...
      {
         if(this.var_280 >= this.var_63.length - 1)
         {
      ...
      {
         ++this.var_280;
         this.var_280 = Math.min(this.var_280,this.var_63.length - 1);
         this.openPage();
      }
      ...
      {
         --this.var_280;
         this.var_280 = Math.max(this.var_280,0);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_63[this.var_280][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_63[this.var_280][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_63[this.var_280][1]).value;
