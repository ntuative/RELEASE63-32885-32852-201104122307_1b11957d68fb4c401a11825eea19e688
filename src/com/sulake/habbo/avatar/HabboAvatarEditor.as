package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1324:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1323:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_1140:AvatarEditorHandler;
      ...
      private var var_929:IFigureData;
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_194)
         {
            ...
            _loc3_ = this.var_616["null"];
            _loc2_.loadAvatarData(const_1324,FigureData.const_77);
            _loc3_.loadAvatarData(const_1323,FigureData.FEMALE);
            this.var_103 = new Map();
            this.var_496 = new Map();
            this.var_103.add(AvatarEditorFigureCategory.const_754,new BodyModel(this));
            this.var_103.add(AvatarEditorFigureCategory.const_51,new HeadModel(this));
            this.var_103.add(AvatarEditorFigureCategory.const_234,new TorsoModel(this));
            this.var_103.add(AvatarEditorFigureCategory.const_807,new LegsModel(this));
            ...
            this.var_496.add(AvatarEditorSideCategory.const_107,new WardrobeModel(this));
            this.var_496.add(AvatarEditorSideCategory.const_499,new ClubPromoModel(this));
            this.var_194 = true;
         }
      }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_929.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_929.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_258 == null)
            {
               this.var_258 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_73,HabboWindowStyle.const_29,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_495 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         this.var_929 = this.var_495.getFigureData(AvatarType.const_122);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1140 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_616[this.var_914];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1394 != null)
         {
            ...
            this.var_1394.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1718;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1139 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1322)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1587.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_495.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_495.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1310.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1684)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1139 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1310.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1139 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_496.getValue(AvatarEditorSideCategory.const_107);
      }
