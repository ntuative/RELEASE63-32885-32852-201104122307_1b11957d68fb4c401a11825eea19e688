package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_1056:AvatarActionManager;
      ...
      private var var_1021:ActionDefinition;
      
      private var var_564:String;
      
      private var var_1581:PartOffsetData;
      ...
      {
         this.var_1581.loadOffsets(param1);
      }
      ...
      public function initActions(param1:IAssetLibrary, param2:XML) : void
      {
         ...
         this.var_1056 = new AvatarActionManager(param1,this.var_564,param2);
         this.var_1021 = this.var_1056.getDefaultAction();
      }
      ...
      public function initFigureData(param1:XML) : Boolean
      {
         ...
         return this.var_394.parse(param1);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         this.var_394.injectXML(param1);
      }
      ...
      public function getPartColor(param1:IAvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = this.var_394.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = this.var_394.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         return this.var_1056.getActionDefinition(param1);
      }
      
      public function getActionDefinitionWithState(param1:String) : ActionDefinition
      {
         return this.var_1056.getActionDefinitionWithState(param1);
      }
      ...
      {
         return this.var_1056.sortActions(param1);
      }
      ...
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         ...
         {
            this.var_692[param1] = new Dictionary();
         }
         if(this.var_692[param1][param2])
         {
            return this.var_692[param1][param2];
         }
         this.var_692[param1][param2] = this.var_394.getMandatorySetTypeIds(param1,param2);
         return this.var_692[param1][param2];
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return this.var_394.getDefaultPartSet(param1,param2);
      }
      
      public function getCanvasOffsets(param1:Array, param2:String, param3:int) : Array
      {
         return this.var_1056.getCanvasOffsets(param1,param2,param3);
      }
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1669[param3];
      ...
      public function getParts(param1:String, param2:IAvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         for each(_loc16_ in _loc20_)
         {
            ...
            _loc29_ = this.var_394.getSetType(_loc16_);
            if(_loc29_)
            {
               _loc30_ = this.var_394.getPalette(_loc29_.paletteID);
               if(_loc30_)
               {
      ...
      {
         return this.var_1581.getOffset(param1,param2,param3,param4,param5,param6);
      }
