package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1310:IWindowContainer;
      
      public static var var_1587:IWindowContainer;
      ...
      private var var_365:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1163 = [];
         this.var_1403 = [AvatarEditorFigureCategory.const_754,AvatarEditorFigureCategory.const_51,AvatarEditorFigureCategory.const_234,AvatarEditorFigureCategory.const_807,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_107];
         super();
         ...
         if(var_1310 == null)
         {
            ...
            var_1310 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1587 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1587 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_425 = new Timer(1000);
         this.var_425.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_425.stop();
            this.var_425.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_425 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1.length != this.var_1163.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1163.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2449 = this.canChangeOutfit();
            this.var_425.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_365 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_365.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_365.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1163.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_365.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_365.numSelectables)
               {
                  this.var_365.getSelectableAt(_loc6_).x = this.var_365.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
         }
         this.var_365.setSelected(this.var_365.getSelectableAt(0));
         this.attachImages();
         this.update();
      }
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_45) && (this.var_1764 == AvatarEditorSideCategory.const_107 || this.var_2447))
         {
         ...
         this.setViewToCategory(this.var_354);
      }
      ...
      {
         if(this.var_1764 == AvatarEditorSideCategory.const_107)
         {
            this.var_2447 = false;
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_767:
               break;
            case AvatarEditorSideCategory.const_499:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_499);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_354 = param1;
         this.var_365.setSelected(this.var_365.getSelectableByName(param1));
      }
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "save":
                  ...
                  this.var_2448 = new Date().valueOf();
                  this.var_2449 = false;
                  this.var_425.start();
      ...
      private function canChangeOutfit() : Boolean
      {
         ...
         return _loc1_ - this.var_2448 > 5000;
      }
   }
}
