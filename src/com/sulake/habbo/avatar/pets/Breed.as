package com.sulake.habbo.avatar.pets
{
   public class Breed extends PetEditorInfo implements IBreed
   {
      ...
      public function Breed(param1:XML)
      {
         ...
         this.var_2160 = parseInt(param1.@pattern);
         this.var_914 = String(param1.@gender);
         this.var_1528 = Boolean(parseInt(param1.@colorable));
         this.var_2161 = String(param1.@localizationKey);
