package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem implements IAvatarImageListener
   {
      ...
      private var var_1396:IWindow;
      
      private var var_741:IFigurePartSet;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         this.var_741 = param3;
         this._window = param1;
         this.var_1396 = this._window.findChildByTag("BG_COLOR");
         this._colors = param4;
         ...
         if(param3 != null)
         {
            ...
            {
               this.var_1722 = Math.max(this.var_1722,_loc6_.colorLayerIndex);
            }
         }
         this.var_420 = this.var_68.controller.avatarRenderManager;
      ...
      private function updateThumbVisualization() : void
      {
         ...
         if(_loc1_)
         {
            if(this.var_698 != null && !this.var_1724)
            {
               _loc3_ = this.var_698;
            }
            else
         ...
         if(this.isSelected)
         {
            this.var_1396.color = this.const_2049;
         }
         else
         {
            this.var_1396.color = this.const_2048;
         }
      ...
      private function analyzePartLayers() : Boolean
      {
         ...
         for each(_loc2_ in this.partSet.parts)
         {
            if(_loc7_)
            {
               _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + this.const_353[_loc6_] + "_" + FigureData.const_150;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         if(this.var_617 == null)
         {
            if(!this.analyzePartLayers())
            {
               if(!this.var_1723)
               {
                  ...
                  this.var_1723 = _loc9_.content as BitmapData;
               }
         ...
         for each(_loc2_ in _loc8_)
         {
            ...
            if(_loc4_)
            {
               ...
               if(this.var_1724 && _loc2_.colorLayerIndex > 0)
               {
