package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1772:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1549:IAvatarImage;
      ...
      private var var_2184:ByteArray;
      
      private var var_2183:ImageData;
      
      private var var_1017:PaletteMap;
      
      private var var_893:Array;
      
      private var var_894:Point;
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_712 == GeometryType.const_1216 && param1 == GeometryType.const_1126 || this.var_712 == GeometryType.const_1126 && param1 == GeometryType.const_1216)
         {
            this.var_712 = param1;
            this.var_87 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
            ...
            if(this.var_343.definition.isAnimation)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     ...
                     if(_loc14_.type == AnimationLayerData.const_708)
                     {
                        if(_loc14_.action != null)
                        {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_583)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1549.getFigure(),_loc5_,this.var_712,_loc3_,_loc6_,_loc7_);
         ...
         if(this.var_430 == null)
         {
            ...
            this.var_430 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_343);
            if(this.var_430 == null)
            {
               return null;
            }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_87)
         {
            this.var_87 = this._structure.getCanvas(this._scale,this.var_712);
            if(!this.var_87)
            {
               return null;
            }
            this.var_2185 = new Point(0,this.var_87.height - int(this.var_87.width / 4));
         }
         ...
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_916 || _loc10_ == AvatarAction.const_412;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1352 = this.var_113.bodyPartId;
               this.var_176 = this.var_113.partType;
               this.var_1628 = this.var_113.partId;
               ...
               if(_loc6_)
               {
                  ...
                  else
                  {
                     ...
                     if(this.var_113.flippedPartType != this.var_176)
                     {
                        this.var_176 = this.var_113.flippedPartType;
                     }
                  }
               }
               this.var_1351 = this._scale + "_" + this.var_113.action.assetPartDefinition + "_" + this.var_176 + "_" + this.var_1628 + "_" + _loc5_ + "_" + this._frame;
               this.var_413 = this._assets.getAssetByName(this.var_1351) as BitmapDataAsset;
               if(this.var_413 == null)
               {
                  this.var_1351 = this._scale + "_std_" + this.var_176 + "_" + this.var_1628 + "_" + _loc5_ + "_0";
                  this.var_413 = this._assets.getAssetByName(this.var_1351) as BitmapDataAsset;
               }
               if(!(!this.var_413 || !this.var_413.content))
               {
                  ...
                  {
                     this.var_1017 = this._structure.renderManager.paletteManager.getPalette(this.var_113.paletteMapId);
                     if(this.var_1017 != null)
                     {
                        this.var_895 = this.var_413.content as BitmapData;
                        this.var_177 = new BitmapData(this.var_895.width,this.var_895.height);
                        this.var_2184 = this.var_1017.colorize(this.var_895.getPixels(this.var_895.rect));
                        this.var_177.setPixels(this.var_177.rect,this.var_2184);
                     }
                     else
                     {
                  ...
                  if(_loc11_ && (this.var_1352 == AvatarBodyPartType.const_234 || this.var_1352 == AvatarBodyPartType.const_1625 || this.var_1352 == AvatarBodyPartType.const_1680) && this.var_113.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  {
                     this.var_177.colorTransform(this.var_177.rect,this.var_113.color.colorTransform);
                  }
                  if(this.var_113.isBlendable)
                  {
                     this.var_177.colorTransform(this.var_177.rect,this.var_113.blendTransform);
                  }
                  this.var_894 = this.var_413.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_52)
                     {
                  ...
                  this.var_2183 = new ImageData(this.var_177,this.var_894,_loc7_);
                  this.var_893.push(this.var_2183);
               }
            }
            _loc8_--;
         }
         ...
         var _loc13_:ImageData = this.createUnionImage(this.var_893,_loc6_);
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2185.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_52)
            {
         ...
         _loc8_ = this.var_893.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_893.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
