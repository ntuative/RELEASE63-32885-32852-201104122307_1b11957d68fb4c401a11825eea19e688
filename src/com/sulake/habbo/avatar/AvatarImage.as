package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1421:String = "Default";
      
      private static const const_1420:int = 2;
      
      private static const const_1422:String = AvatarSetType.const_36;
      ...
      private var var_1021:IActiveActionData;
      ...
      private var var_2817:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1422,const_1420);
         this.var_333 = new Array();
         this.var_1021 = new ActiveActionData(AvatarAction.const_367);
         this.var_1021.definition = this._structure.getActionDefinition(const_1421);
         this.resetActions();
      ...
      {
         return this._structure.getPartColor(this.var_608,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1943;
         if(param2 < AvatarDirectionAngle.const_1234)
         {
            param2 = AvatarDirectionAngle.const_341 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_341)
         {
            param2 -= NaN;
         }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_282.length == 1 && this.var_91 == this.var_1808)
         {
            return this.var_91 + this.var_560 + this.var_683 % 4;
         }
      ...
      {
         if(param3 != this.var_2816 || param2 != this.var_2817 || param1 != this.var_2818)
         {
            this.var_2816 = param3;
            this.var_2817 = param2;
            this.var_2818 = param1;
            this.var_2022 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1329 || this.var_47 == null || (this.var_47.width != _loc5_.width || this.var_47.height != _loc5_.height))
         {
            if(this.var_47 != null && !this.var_1329)
            {
               this.var_47.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_289.definition.geometryType,this.var_91);
         this.var_47.lock();
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_289.definition.geometryType,this.var_91);
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_333.push(new ActiveActionData(param1,param2,this.var_683));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_289 = this.var_1021;
         this.var_289.definition = this.var_1021.definition;
         this.resetBodyPartCache(this.var_1021);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_560 = "";
         this.var_282 = this._structure.sortActions(this.var_333);
         if(this.var_282 == null)
         {
            this.var_838 = new Array(0,0,0);
            if(this.var_1571 != "")
            {
               _loc1_ = true;
               this.var_1571 = "";
         ...
         {
            this.var_838 = this._structure.getCanvasOffsets(this.var_282,this._scale,this.var_91);
            for each(_loc4_ in this.var_282)
            {
               this.var_560 += _loc4_.actionType + _loc4_.actionParameter;
            ...
            if(this.var_1571 != this.var_560)
            {
               _loc1_ = true;
               this.var_1571 = this.var_560;
            }
         }
         this.var_1536 = true;
         return _loc1_;
            ...
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.definition.isAnimation)
               {
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1943 = _loc2_.directionData.offset;
                     }
               ...
               if(_loc1_.actionType == AvatarAction.const_346 || _loc1_.actionType == AvatarAction.WAVE || _loc1_.actionType == AvatarAction.const_412)
               {
                  this.var_1022 = true;
               }
            }
