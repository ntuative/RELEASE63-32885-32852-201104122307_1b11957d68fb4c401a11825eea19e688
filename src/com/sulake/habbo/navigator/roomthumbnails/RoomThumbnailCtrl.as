package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_2039:IButtonWindow;
      
      private var var_2038:IButtonWindow;
      
      private var var_2037:IButtonWindow;
      
      private var var_2838:IWindowContainer;
      
      private var var_2837:IWindowContainer;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_2039 = IButtonWindow(this.find("bg_tab"));
         this.var_2038 = IButtonWindow(this.find("top_tab"));
         this.var_2037 = IButtonWindow(this.find("obj_tab"));
         this.var_2838 = IWindowContainer(this.find("tile_grid"));
         this.var_2837 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_2039,this.onBgTabButton);
         Util.setProcDirectly(this.var_2038,this.onTopTabButton);
         Util.setProcDirectly(this.var_2037,this.onObjTabButton);
      }
      ...
      {
         this.setEnabled(this.var_2039,this.var_68.mode != ThumbnailEditorModel.const_38);
         this.setEnabled(this.var_2038,this.var_68.mode != ThumbnailEditorModel.const_63);
         this.setEnabled(this.var_2037,this.var_68.mode != ThumbnailEditorModel.const_35);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_2837;
      ...
      private function refreshPositionGrid() : void
      {
         ...
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_603)
            {
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(this._navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_73,HabboWindowStyle.const_29,HabboWindowParam.const_61,new Rectangle(0,0,param1.width,66)));
               param1.addListItem(_loc7_);
            }
            _loc10_ = _loc6_[_loc8_];
            _loc11_ = IRegionWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",WindowType.const_580,HabboWindowStyle.const_44,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
            _loc11_.mouseThreshold = 0;
            _loc12_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_312,HabboWindowStyle.const_44,HabboWindowParam.const_61,new Rectangle(0,0,66,66),this.onImgSel,_loc10_.id));
