package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private var var_1102:IHabboWindowManager;
      ...
      private var var_599:LagWarningLogger = null;
      
      private var var_600:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_599 = new LagWarningLogger();
         this.var_600 = new ToolbarClickTracker(this);
         this.var_1361 = new Array(const_973);
         var _loc4_:int = 0;
         while(_loc4_ < const_973)
         {
            this.var_1361[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1728,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1557,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1552,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_763,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1129,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1102)
            {
               this.var_1102.release(new IIDHabboWindowManager());
               this.var_1102 = null;
            }
            if(this.var_330)
            {
            ...
            if(this.var_197)
            {
               if(!this.var_197.disposed)
               {
                  ...
                  Component(this.var_197).events.removeEventListener(HabboFriendListTrackingEvent.const_361,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_157)
            {
               ...
               {
                  this.var_157.events.removeEventListener(HabboToolbarEvent.const_37,this.onToolbarClick);
               }
            ...
            if(this._roomEngine)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomObjectRoomAdEvent.const_186,this.onRoomAdClick);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_178)
         {
            if(this.var_252 != null)
            {
               this.var_252.configuration = this.var_178;
            }
            if(this.var_251 != null)
            {
               this.var_251.configuration = this.var_178;
            }
            ...
            if(this.var_178)
            {
               ...
               {
                  this.var_599.configure(this.var_178);
               }
               if(this.var_414 != null)
               {
                  this.var_414.configure(this.var_178);
               }
               if(this.var_600 != null)
               {
                  this.var_600.configure(this.var_178);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_678,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_276,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_828,this.onHotelViewEvent);
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_599 != null)
            {
               this.var_599.connection = param1;
            }
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_678:
               this.trackLoginStep(HabboLoginTrackingStep.const_1474,String(this._communication.port));
               break;
            ...
            case HabboCommunicationEvent.const_191:
               ...
               break;
            case HabboCommunicationEvent.const_276:
               this.setErrorContextFlag(3,0);
               this.trackLoginStep(HabboLoginTrackingStep.const_276);
               if(this.var_252 != null)
               {
                  this.var_252.init();
               }
      ...
      {
         this.var_1102 = IHabboWindowManager(param2);
         if(this.var_1102)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_178)
            {
               if(this.var_178.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1361)
                  {
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1206);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1206,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_197).events.addEventListener(HabboFriendListTrackingEvent.const_361,this.onFriendlistTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1129,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_763,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_186,this.onRoomAdClick);
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_330.events.addEventListener(AdEvent.const_450,this.onRoomAdLoad);
      }
      
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_157 = param2 as IHabboToolbar;
         this.var_157.events.addEventListener(HabboToolbarEvent.const_37,this.onToolbarClick);
      }
      ...
      {
         if(param1.type == RoomEngineEvent.const_324)
         {
            if(this.var_1656 < 1)
            {
               if(!this.var_294)
         ...
         else if(param1.type == RoomEngineEvent.const_310)
         {
            if(this.var_294)
            {
               this.var_294.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_414)
               {
                  ...
                  this._connection.send(new ConversionPointMessageComposer("Performance","fps",String(this.var_414.frameRate),_loc2_));
                  ++this.var_1656;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_600)
         {
            this.var_600.track(param1.iconName);
         }
      }
      ...
      {
         this.var_599.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_487 > -1 && _loc2_ < this.var_487)
         {
            ++this.var_1655;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1655);
         }
         if(this.var_487 > -1 && _loc2_ - this.var_487 > 15000)
         {
            ++this.var_1654;
         ...
         if(this.var_251 != null)
         {
            this.var_251.update(param1,this.var_487);
         }
         if(this.var_252 != null)
         {
            this.var_252.update(param1,this.var_487);
         }
         if(this.var_414 != null)
         {
            this.var_414.trackUpdate(param1,this,this.var_487);
         }
         if(this.var_599 != null)
         {
            this.var_599.update(this.var_487);
         }
      }
   }
}
