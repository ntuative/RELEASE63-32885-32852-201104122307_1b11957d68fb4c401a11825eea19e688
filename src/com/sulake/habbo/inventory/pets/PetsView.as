package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      {
         var _loc2_:PetsGridItem = this.var_651.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         if(this.var_651 == null || this.var_651.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_651.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_651.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_651.add(param1.id,_loc2_);
