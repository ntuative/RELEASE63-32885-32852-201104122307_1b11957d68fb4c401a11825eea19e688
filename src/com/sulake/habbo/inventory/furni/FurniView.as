package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_1012:int = 1;
      
      private const const_1802:int = 2;
      
      private const const_1803:int = 3;
      
      private const const_1801:int = 42;
      
      private const const_1800:int = 120;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_432.add(FurniModel.const_47,new FurniGridView(this.var_68,FurniModel.const_47,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case FurniModel.const_47:
               ...
               break;
            case FurniModel.const_403:
               _loc2_.setSelected(_loc2_.getSelectableByName("tab_pets"));
               this.var_433 = FurniModel.const_403;
               break;
            default:
      ...
      public function setViewToState() : void
      {
         ...
         {
            _loc2_ = this.const_1012;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1802;
         }
         else
         {
            _loc2_ = this.const_1803;
         }
         if(this.var_2573 == _loc2_)
         {
            return;
         }
         ...
         switch(_loc2_)
         {
            case this.const_1012:
               _loc3_.visible = true;
               _loc4_.visible = false;
               _loc5_.visible = false;
               break;
            case this.const_1802:
               _loc3_.visible = false;
               _loc4_.visible = true;
               _loc5_.visible = false;
               break;
            case this.const_1803:
               _loc3_.visible = false;
               _loc4_.visible = false;
               _loc5_.visible = true;
      ...
      public function updateActionView() : void
      {
         ...
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            _loc16_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_350);
            ...
            _loc18_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_315);
            ...
            else if(_loc5_.category == FurniCategory.const_344)
            {
         ...
         if(_loc5_ != null)
         {
            if(_loc5_.category == FurniCategory.const_1254)
            {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1800)
         {
            _loc3_ = this.const_1800;
         }
         else if(_loc3_ < this.const_1801)
         {
            _loc3_ = this.const_1801;
         }
         else
         {
         ...
         else if(param1.type == WindowEvent.const_56)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_403);
            }
         }
      }
