package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_403:String = "pets";
      ...
      private var var_1693:Vector.<Array>;
      
      private var var_1692:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_610 = new Timer(const_1313,1);
         ...
         this.var_2306 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_47)
            {
               ...
               {
                  this.var_1693 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1693;
            }
            else
            {
               if(this.var_1692 == null)
               {
                  this.var_1692 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1692;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         else if(param3 == FurniCategory.const_344)
         {
         ...
         if(this.var_918 == null)
         {
            this.var_918 = this._windowManager.buildFromXML(this.var_2306) as IWindowContainer;
         }
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_611.add(const_47,new Array());
         this.var_611.add(const_50,new Array());
         if(this._view != null)
         {
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_295;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_344 || _loc3_.category == FurniCategory.const_305 || _loc3_.category == FurniCategory.const_309)
         {
            if(param1)
            {
               return false;
      ...
      {
         return this.var_611.getValue(param1);
      }
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc3_:Array = this.var_611.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            _loc4_ = 0;
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_816)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
