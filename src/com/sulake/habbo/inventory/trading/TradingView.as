package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1039:uint = 4284532064;
      
      private static const const_1040:uint = 2577770;
      ...
      private var var_691:ItemPopupCtrl;
      ...
      private var var_1055:GroupItem;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_691 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(this.var_2051 == null)
         {
            this.var_2051 = this.createMinimizedWindow();
         }
         if(!this.var_2855)
         {
            return this.var_72;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_72)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_18.ownUserAccepts ? uint(const_1039) : uint(const_1040);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_18.otherUserAccepts ? uint(const_1039) : uint(const_1040);
            }
      ...
      public function removeSelection() : void
      {
         if(this.var_1055)
         {
            this.var_1055.isSelected = false;
            this.var_1055 = null;
         }
      }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1514)
            {
            ...
            this.var_691.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_610);
            this.var_691.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_691.hideDelayed();
         }
      }
         ...
         if(this.var_193.length > 0)
         {
            ...
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_18.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_18.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_691.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_610);
               }
            }
            else
            {
