package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1696:uint = 9;
      
      public static const const_184:uint = 0;
      
      public static const const_209:uint = 1;
      
      public static const const_386:uint = 2;
      
      public static const const_303:uint = 3;
      
      public static const const_545:uint = 4;
      
      public static const const_249:uint = 5;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_56.updateItemList(this.var_777);
         this.var_56.updateItemList(this.var_1454);
      ...
      public function close() : void
      {
         if(this.var_810)
         {
            if(this._state != const_184 && this._state != const_249)
            {
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_778 + " OTHER: " + this.var_1174);
         ...
         {
            case const_184:
               if(param1 == const_209 || param1 == const_249)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_56.alertPopup(TradingView.const_1199);
         }
         else if(param1 is TradingAcceptEvent)
         {
            ...
            {
               this.var_1174 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_56.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            {
               this.var_56.alertPopup(TradingView.const_1130);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_265.length < const_1696)
         {
