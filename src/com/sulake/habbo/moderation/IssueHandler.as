package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_163:IssueBundle;
      
      private var _window:IFrameWindow;
      
      private var var_522:UserInfoCtrl;
      
      private var var_1199:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         var _loc3_:IssueMessageData = this.var_163.getHighestPriorityIssue();
         this.var_522 = new UserInfoCtrl(this._window,this.var_67,_loc3_.message);
         this.var_1199 = new UserInfoCtrl(this._window,this.var_67,_loc3_.message);
         this.var_522.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(this._window.findChildByName("reported_user_info"));
         if(this.var_163.reportedUserId > 0)
         {
            this.var_1199.load(_loc4_,this.var_163.reportedUserId);
         }
         else
         {
         ...
         Logger.log("HARASSER: " + this.var_163.reportedUserId);
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc2_:Array = this.var_163.issues;
         var _loc3_:int = 0;
      ...
      {
         if(this.var_67 != null && this.var_67.issueManager != null && this.var_163 != null)
         {
            this.var_67.issueManager.removeHandler(this.var_163.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_67.issueManager.closeBundle(this.var_163.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_67.issueManager.closeBundle(this.var_163.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_67.issueManager.closeBundle(this.var_163.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_67.issueManager.releaseBundle(this.var_163.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = this.var_163.getHighestPriorityIssue().issueId;
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            _loc3_ = this.var_163.getHighestPriorityIssue();
            this.var_522 = new UserInfoCtrl(this._window,this.var_67,_loc3_.message);
            this.var_522.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
