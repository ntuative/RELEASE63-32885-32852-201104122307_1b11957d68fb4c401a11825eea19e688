package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1837:int = 1000;
      ...
      private var var_1667:IMessageComposer;
      ...
      {
         this.var_787 = IWindowContainer(this.var_35.getXmlWindow("chatlog_roomheader"));
         this.var_786 = IWindowContainer(this.var_35.getXmlWindow("chatlog_chatline"));
         ...
         this.var_35.connection.send(this.var_1667);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         ...
         return IWindowContainer(this.var_786.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_979.length < var_1837)
         {
            ...
            param1.width = this.var_786.width;
            param1.height = this.var_786.height;
            var_979.push(param1);
         }
         else
         {
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1480.getValue(param2.chatterName))
            {
               this.var_1480.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1480.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1481)
         {
            this.storeChatLineWindow(_loc1_);
         }
         for each(_loc1_ in this.var_1482)
         {
