package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1747:int = 6;
      
      public static const const_1510:int = 7;
      ...
      private var var_1819:Dictionary;
      
      public function WindowTracker()
      {
         this.var_1819 = new Dictionary();
         super();
      }
      ...
      {
         var _loc2_:Dictionary = this.var_1819[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_1819[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
