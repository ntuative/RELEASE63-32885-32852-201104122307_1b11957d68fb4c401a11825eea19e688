package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1254:IDropMenuWindow;
      ...
      private var var_1024:OffenceCategoryData;
      
      private var var_1025:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1252 = IButtonWindow(this.var_35.getXmlWindow("modact_offence"));
         this.var_1253 = IButtonWindow(this.var_35.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_1866;
         ...
         this.var_1254 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1254);
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = this.var_1024 != null;
         if(this.var_1025 != null)
         {
            this._frame.findChildByName("offence_txt").caption = this.var_1025.name;
            this._frame.findChildByName("offence_category").visible = true;
         }
         else if(this.var_1024 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_1024.offences,this.var_1252,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_35.initMsg.offenceCategories,this.var_1253,this.onOffenceCtgButton);
      ...
      {
         return WindowTracker.const_1510;
      }
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.connection.send(new ModAlertMessageComposer(this.var_1552,this.var_546.text,this.var_1551));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_1024 = this.var_35.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_1025 = this.var_1024.offences[_loc3_];
         this.var_546.text = this.var_1025.msg;
         this.var_598 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.connection.send(new ModKickMessageComposer(this.var_1552,this.var_546.text,this.var_1551));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1254.selection < 0)
         {
            this.var_35.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_35.connection.send(new ModBanMessageComposer(this.var_1552,this.var_546.text,this.getBanLength(),this.var_1551));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_1254.selection;
