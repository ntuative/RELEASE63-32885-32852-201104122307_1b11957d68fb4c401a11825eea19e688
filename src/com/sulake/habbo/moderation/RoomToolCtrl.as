package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1205:IDropMenuWindow;
      
      private var var_546:ITextFieldWindow;
      
      private var var_598:Boolean = true;
      
      private var var_993:ICheckBoxWindow;
      
      private var var_1499:ICheckBoxWindow;
      
      private var var_1500:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_35.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_357));
      ...
      public function populate() : void
      {
         ...
         this.var_546 = ITextFieldWindow(this._frame.findChildByName("message_input"));
         this.var_546.procedure = this.onInputClick;
         this.var_1205 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1205);
         this.var_1205.procedure = this.onSelectTemplate;
         this.var_993 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1499 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1500 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_35,WindowTracker.const_951,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_598 || this.var_546.text == "")
         {
            this.var_35.windowManager.alert("Alert","You must input a message to the user",0,this.onAlertClose);
            return;
         }
         var _loc2_:int = this.determineAction(param1,this.var_993.isSelected);
         this.var_35.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1589,_loc2_,this.var_546.text,"",""));
         if(this.var_1499.isSelected || this.var_1500.isSelected || this.var_993.isSelected)
         {
            this.var_35.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1499.isSelected,this.var_1500.isSelected,this.var_993.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1577);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1741);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_35.initMsg.roomMessageTemplates[this.var_1205.selection];
         if(_loc3_ != null)
         {
            this.var_598 = false;
            this.var_546.text = _loc3_;
         }
      }
   }
}
