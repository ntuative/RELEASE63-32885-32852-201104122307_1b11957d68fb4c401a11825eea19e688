package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2088:String = "my_issues";
      
      private const const_2087:String = "open_issues";
      
      private const const_2089:String = "picked_issues";
      
      private const const_2098:String = "closed_issues";
      ...
      private var var_1903:IIssueBrowserView;
      
      private var var_1902:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_272 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_272.numTabItems)
            {
               _loc5_ = this.var_272.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_56,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_272 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_272 == null || this.var_272.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_272.selector.getSelectableByName("open_issues");
         this.var_272.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_377.view.width = this.var_272.container.width;
         this.var_377.view.height = this.var_272.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2088:
               ...
               {
                  this.var_1901 = new MyIssuesView(this.issueManager,this,this.var_272.container);
               }
               return this.var_1901;
            case this.const_2087:
               if(this.var_1903 == null)
               {
                  this.var_1903 = new OpenIssuesView(this.issueManager,this,this.var_272.container);
               }
               return this.var_1903;
            case this.const_2089:
               if(this.var_1902 == null)
               {
                  this.var_1902 = new PickedIssuesView(this.issueManager,this,this.var_272.container);
               }
