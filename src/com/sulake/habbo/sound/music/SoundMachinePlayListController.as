package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_70 = param2;
         this.var_794 = [];
         this.var_794.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_794.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_794)
         {
         ...
         this.var_82.addEventListener(RoomEngineSoundMachineEvent.const_844,this.onSoundMachinePlayEvent);
         this.var_82.addEventListener(RoomEngineSoundMachineEvent.const_700,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_82)
            {
               this.var_82.removeEventListener(RoomEngineSoundMachineEvent.const_844,this.onSoundMachinePlayEvent);
               this.var_82.removeEventListener(RoomEngineSoundMachineEvent.const_700,this.onSoundMachineStopEvent);
               this.var_82 = null;
            }
            this._disposed = true;
         }
      ...
      public function stopPlaying() : void
      {
         this.var_441 = -1;
         this.var_649 = false;
         this.var_70.stop(HabboMusicPrioritiesEnum.const_125);
      }
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_70.playSong(param1,HabboMusicPrioritiesEnum.const_125,_loc3_,0,0,0))
         {
