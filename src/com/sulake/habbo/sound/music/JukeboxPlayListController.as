package com.sulake.habbo.sound.music
{
   ...
   public class JukeboxPlayListController implements IPlayListController
   {
      ...
      public function JukeboxPlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_794 = [];
         this.var_794.push(new NowPlayingMessageEvent(this.onNowPlayingMessage));
         this.var_794.push(new JukeboxSongDisksMessageEvent(this.onJukeboxSongDisksMessage));
         this.var_794.push(new JukeboxPlayListFullMessageEvent(this.onJukeboxPlayListFullMessage));
      ...
      private function onNowPlayingMessage(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_70.playSong(_loc3_.currentSongId,HabboMusicPrioritiesEnum.const_125,_loc3_.syncCount / 1000,0,1,1);
         ...
         this.var_1842 = _loc3_.currentPosition;
         this._soundManager.events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_339,HabboMusicPrioritiesEnum.const_125,_loc3_.currentSongId,_loc3_.currentPosition));
      }
      ...
      private function onJukeboxSongDisksMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.songDisks.length)
         {
            ...
            if(_loc7_ == null)
            {
               ...
               if(this.var_795.indexOf(_loc5_) < 0)
               {
                  this.var_795.push(_loc5_);
      ...
      private function onJukeboxPlayListFullMessage(param1:IMessageEvent) : void
      {
         ...
         this._events.dispatchEvent(new PlayListStatusEvent(PlayListStatusEvent.const_687));
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         var _loc3_:int = this.var_795.indexOf(param1.id);
         if(_loc3_ >= 0)
         {
            this.var_795.splice(_loc3_,1);
         }
         if(this.var_795.length == 0)
         {
            this._events.dispatchEvent(new PlayListStatusEvent(PlayListStatusEvent.PLAY_LIST_UPDATED));
