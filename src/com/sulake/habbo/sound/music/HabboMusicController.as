package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1383:int = HabboMusicPrioritiesEnum.const_125;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_794.push(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_794.push(new UserSongDisksInventoryMessageEvent(this.onSongDiskInventoryMessage));
         for each(_loc5_ in this.var_794)
         {
            this._connection.addMessageEvent(_loc5_);
         }
         this.var_82.addEventListener(RoomEngineSoundMachineEvent.const_659,this.onJukeboxInit);
         this.var_82.addEventListener(RoomEngineSoundMachineEvent.const_245,this.onJukeboxDispose);
         this.var_82.addEventListener(RoomEngineSoundMachineEvent.const_831,this.onSoundMachineInit);
         this.var_82.addEventListener(RoomEngineSoundMachineEvent.const_776,this.onSoundMachineDispose);
         this.var_1191 = new Timer(1000);
         this.var_1191.start();
         this.var_1191.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
         this._events.addEventListener(SoundCompleteEvent.TRAX_SONG_COMPLETE,this.onSongFinishedPlayingEvent);
         _loc6_ = 0;
         while(_loc6_ < HabboMusicPrioritiesEnum.const_262)
         {
            this.var_518[_loc6_] = null;
            this.var_788[_loc6_] = 0;
            _loc6_++;
         }
      }
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_1839)
            {
            ...
            {
               this._events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_533,_loc2_,param1.id,-1));
            }
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_82)
            {
               this.var_82.removeEventListener(RoomEngineSoundMachineEvent.const_659,this.onJukeboxInit);
               this.var_82.removeEventListener(RoomEngineSoundMachineEvent.const_245,this.onJukeboxDispose);
               this.var_82.removeEventListener(RoomEngineSoundMachineEvent.const_831,this.onSoundMachineInit);
               this.var_82.removeEventListener(RoomEngineSoundMachineEvent.const_776,this.onSoundMachineDispose);
            }
      ...
      public function updateVolume(param1:Number) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < HabboMusicPrioritiesEnum.const_262)
         {
      ...
      private function sendNextSongRequestMessage(param1:TimerEvent) : void
      {
         ...
         this._connection.send(new GetSongInfoMessageComposer(this.var_789));
         Logger.log("Requested song info\'s : " + this.var_789);
         this.var_789 = new Array();
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               while(this.var_790.indexOf(_loc6_.id) != -1)
               {
                  this.var_790.splice(this.var_790.indexOf(_loc6_.id),1);
                  if(this.var_790.length == 0)
                  {
                     this._events.dispatchEvent(new SongDiskInventoryReceivedEvent(SongDiskInventoryReceivedEvent.const_617));
                  }
               }
      ...
      {
         if(param2 == -1 || param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_262)
         {
            return false;
         }
         ...
         this.var_1839 = this.getSongRequestCountAtPriority(param1);
         this.var_1840 = param2;
         if(this._priorityPlaying <= const_1383)
         {
            this.notifySongPlaying(_loc4_);
         }
         if(param1 > HabboMusicPrioritiesEnum.const_125)
         {
            this._events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_521,param1,_loc4_.id,-1));
         }
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2616 != param1.id || _loc3_ > this.var_2617 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2616 = param1.id;
            this.var_2617 = _loc3_;
         }
      }
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_517 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_82,this._connection) as IPlayListController;
      }
