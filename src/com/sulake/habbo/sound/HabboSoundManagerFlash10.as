package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private static const const_1458:int = 60;
      ...
      private var var_562:Number = 1.0;
      ...
      private var var_852:TraxSequencer;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null, param4:Boolean = true)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_838,this.onTraxLoadComplete);
      ...
      private function addTraxSongForDownload(param1:int, param2:String) : IHabboSound
      {
         ...
         if(!_loc3_.ready)
         {
            this.var_1289.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      private function createTraxInstance(param1:int, param2:String, param3:Boolean = true) : TraxSequencer
      {
         ...
         var _loc5_:TraxSequencer = new TraxSequencer(param1,_loc4_,this.var_688,events);
         _loc5_.volume = this.var_562;
      ...
      private function validateSampleAvailability(param1:TraxSequencer, param2:Boolean) : void
      {
         ...
         {
            if(this.var_688.getValue(int(_loc4_[_loc6_])) == null)
            {
               if(param2)
               {
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_157 = IHabboToolbar(param2);
      ...
      {
         if(this.var_178 == null || this._connection == null || this._roomEngine == null || this.var_70 != null)
         {
            return;
         }
      ...
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1521,this.var_851));
         this.var_851 = -1;
         this.var_852 = null;
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            this.setHabboToolbarIconState(this.var_562 > 0);
            return;
         }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_562 * 100)));
         }
      }
      ...
      {
         this.var_562 = param1;
         this.var_70.updateVolume(this.var_562);
      ...
      private function setHabboToolbarIconState(param1:Boolean) : void
      {
         ...
         this.var_157.events.dispatchEvent(_loc2_);
      }
      ...
      private function processLoadedSamples() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(this.var_1288.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1458 && this.var_1288.length > 0)
            {
               _loc3_ = this.var_1288.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_687.length == 0 && this.var_851 != -1)
            {
               this.var_852.ready = true;
               _loc4_ = this.var_851;
               this.var_851 = -1;
               this.var_852 = null;
               events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_838,_loc4_));
            }
         }
      }
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_852 == null && this.var_1289.length > 0)
         {
            _loc1_ = this.var_1289.getKey(0);
            _loc2_ = this.var_1289.remove(_loc1_);
            if(_loc2_ != null)
            {
               this.validateSampleAvailability(_loc2_,true);
               if(_loc2_.ready)
               {
                  events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_838,_loc1_));
               }
               else
               {
                  this.var_852 = _loc2_;
