package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_2065:int = 152;
      
      private const const_2057:int = 16;
      
      private const const_1328:int = 4;
      
      private const const_2059:uint = 14342874;
      
      private const const_2060:uint = 3815994;
      
      private const const_2061:uint = 2085362;
      
      private const const_2054:uint = 39616;
      
      private const const_2062:uint = 10513106;
      
      private const const_2055:uint = 8734654;
      
      private const const_2063:uint = 9094430;
      
      private const const_2056:uint = 6200576;
      
      private const const_2053:String = "happiness";
      
      private const const_2064:String = "experience";
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_2053,param1.nutrition,param1.nutritionMax,this.const_2054,this.const_2061);
         this.updateStateElement(this.const_2064,param1.experience,param1.experienceMax,this.const_2055,this.const_2062);
         this.updateStateElement(this.const_2058,param1.energy,param1.energyMax,this.const_2056,this.const_2063);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_2065,this.const_2057,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_2059);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_2060);
         var _loc9_:Rectangle = new Rectangle(1,1 + this.const_1328,_loc7_.width - 2,_loc7_.height - 2 - this.const_1328);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,this.const_1328);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_561) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_202 && this.var_202.getPetId() == this.var_561)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1687,true);
