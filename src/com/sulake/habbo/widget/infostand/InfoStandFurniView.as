package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      protected var var_54:IBorderWindow;
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         this.var_241 = this.var_54.findChildByTag("catalog");
      ...
      {
         if(this._widget == null || this.var_54 == null)
         {
            return;
         }
         var _loc2_:IWindow = this.var_54.findChildByName("furni_details_spacer");
         if(_loc2_ != null)
         {
            _loc2_.visible = param1;
         }
         var _loc3_:IWindow = this.var_54.findChildByName("furni_details_text") as ITextWindow;
         if(_loc3_ != null)
         {
