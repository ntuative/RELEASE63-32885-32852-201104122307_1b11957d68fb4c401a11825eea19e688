package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private var var_1104:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1105 = 0;
         this.var_1104 = param2.rectangle.clone();
         this.var_1104.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1104.width)
         {
            return false;
         }
         if(this.var_1105 + param1.height > this.var_1104.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1104.width)
         {
            this._offsetX = 0;
            this.var_1105 += param1.height + this.const_2043;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1105);
         this._offsetX += param1.width + this.const_2044;
         return true;
      }
