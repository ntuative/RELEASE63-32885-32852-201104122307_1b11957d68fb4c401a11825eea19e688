package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_1203:TagListRenderer;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1203 = new TagListRenderer(param1,this.onTagSelected);
      }
      ...
      {
         if(this.var_53 == null || this.var_54 == null || this.var_102 == null)
         {
            return;
         }
         this.var_53.height = this.var_53.scrollableRegion.height;
         this.var_54.height = this.var_53.height + 20;
         this._window.width = Math.max(this.var_54.width,this.var_102.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_54.width < this.var_102.width)
         {
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            if(param1 == "")
            {
               ...
               _loc3_.textColor = this.const_1775;
            }
            else
            {
         ...
         _loc3_.text = param1;
         _loc3_.height = Math.min(_loc3_.textHeight + this.const_972,this.const_2041);
         if(param2)
         {
            _loc3_.addEventListener(WindowKeyboardEvent.const_407,this.onMottoKeyboard);
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc3_.removeEventListener(WindowKeyboardEvent.const_407,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1203.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function updateInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.setMotto(param1.motto,param1.type == RoomWidgetUserInfoUpdateEvent.const_132);
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2218 > this.const_2042 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2218 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1775;
         }
      }
