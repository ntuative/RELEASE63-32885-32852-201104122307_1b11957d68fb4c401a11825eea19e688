package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class MusicInventoryGridView
   {
      ...
      private var var_100:MusicInventoryGridItem;
      ...
      public function refresh() : void
      {
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            this.var_647.addGridItem(_loc12_.window);
      ...
      public function setPreviewIconToPause() : void
      {
         ...
         {
            this.var_100.playButtonState = MusicInventoryGridItem.const_1265;
         }
      }
      ...
      public function setPreviewIconToPlay() : void
      {
         if(this.var_100 != null)
         {
            this.var_100.playButtonState = MusicInventoryGridItem.const_473;
         }
      }
      ...
      private function gridItemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         var _loc4_:int = 0;
         var _loc5_:* = null;
         var _loc3_:* = param1.type == WindowMouseEvent.const_178;
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            if(param2.name == "button_to_playlist" || _loc3_)
            {
               if(this.var_100 != null)
               {
                  this.var_100.deselect();
                  this.stopPreview();
                  this._widget.sendAddToPlayListMessage(this.var_100.diskId);
                  this.var_100 = null;
               }
            }
            else if(param2.name == "button_play_pause")
            {
               if(this.var_100.playButtonState == MusicInventoryGridItem.const_473)
               {
                  this.var_100.playButtonState = MusicInventoryGridItem.const_1141;
                  this._widget.playUserSong(this.var_100.songId);
               }
               else
               {
                  this.stopPreview();
            ...
            {
               _loc4_ = this.var_647.getGridItemIndex(param1.window);
               if(_loc4_ != -1)
               {
                  _loc5_ = this._items.getWithIndex(_loc4_);
                  if(_loc5_ != this.var_100)
                  {
                     if(this.var_100 != null)
                     {
                        this.var_100.deselect();
