package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_788:String = "PLSV_ADD_SONGS";
      
      public static const const_1136:String = "PLSV_START_PLAYBACK";
      
      public static const const_512:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_45 != const_512)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_423[this.var_45];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_423[const_788];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_423.add(const_512,_loc1_);
