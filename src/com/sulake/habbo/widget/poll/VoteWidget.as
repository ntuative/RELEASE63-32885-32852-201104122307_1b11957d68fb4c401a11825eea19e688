package com.sulake.habbo.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_151.reset();
            this.var_151.removeEventListener(TimerEvent.TIMER,this.updateEvent);
            this.var_151 = null;
         }
         this._config = null;
         super.dispose();
      ...
      private function showVoteQuestion(param1:RoomWidgetVoteUpdateEvent) : void
      {
         ...
         {
            this.var_151 = new Timer(1000);
            this.var_151.addEventListener(TimerEvent.TIMER,this.updateEvent);
         }
      ...
      private function updateTimerView() : void
      {
         ...
         var _loc1_:int = getTimer() - this.var_1811;
      ...
      {
         var _loc2_:int = getTimer() - this.var_1811;
