package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_499:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_499.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_499 = null;
         }
         if(this.var_47 != null)
         {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetLoadingBarUpdateEvent.const_288,this.onHideLoadingBar);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetLoadingBarUpdateEvent.const_288,this.onHideLoadingBar);
      }
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         if(this.var_499 == null)
         {
            this.var_499 = new Sprite();
            this.var_499.addChild(new Bitmap(this.var_47));
            this.var_499.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_499.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_47;
            }
         }
         _loc2_.setDisplayObject(this.var_499);
      ...
      private function clickHandler(param1:Event) : void
      {
         if(this.var_1134 != "")
         {
            HabboWebTools.openWebPage(this.var_1134);
         }
      }
   }
}
