package com.sulake.habbo.widget.furniture.petpackage
{
   ...
   public class PetPackageFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPetPackageUpdateEvent.const_423,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPetPackageUpdateEvent.const_423,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPetPackageUpdateEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomWidgetPetPackageUpdateEvent.const_579:
               ...
               break;
            case RoomWidgetPetPackageUpdateEvent.const_423:
               if(event.objectId != this.var_352)
               {
                  return;
               }
               this.var_625 = event.image;
      ...
      private function sendOpenPetPackage() : void
      {
         ...
         if(this.var_1153 || this.var_352 == -1)
         {
            return;
         }
         ...
         {
            this.var_1153 = true;
            message = new RoomWidgetOpenPetPackageMessage(RoomWidgetOpenPetPackageMessage.const_927,this.var_352,name);
