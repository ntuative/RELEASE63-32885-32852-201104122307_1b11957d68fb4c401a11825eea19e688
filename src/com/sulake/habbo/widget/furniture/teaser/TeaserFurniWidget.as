package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1790:int = 0;
      
      private const const_1793:int = 1;
      
      private const const_1791:int = 2;
      
      private const const_1792:int = 3;
      
      private const const_1789:int = 4;
      
      private const const_2070:int = 0;
      ...
      private const const_2073:int = 4;
      
      private const const_2071:int = 5;
      
      private const const_1794:String = "deco_img";
      
      private const const_1795:String = "dialog_bg";
      
      private const const_2074:String = "%campaign%_dialog_bg.png";
      
      private const const_354:String = "%campaign%_gift_package.png";
      
      private const const_2068:String = "%campaign%_gift_content.png";
      
      private const const_2076:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboInventory)
      {
         ...
         this.var_1442 = this.var_164.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1442 += "Viral/";
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_559,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_957,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_912,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_559,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_559:
               _loc2_ = this.const_1790;
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_912:
               ...
               {
                  _loc2_ = this.const_1789;
               }
               this._shareId = null;
               this.var_1444 = param1.itemCategory;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_957:
               _loc2_ = this.const_1793;
               this.var_352 = param1.objectId;
         ...
         if(this._window && (this.var_1441 != _loc2_ || _loc3_ != this.var_182))
         {
            this._window.dispose();
            this._window = null;
         }
         ...
         if(!this._window)
         {
            switch(this.var_1441)
            {
               ...
               case this.const_1793:
                  if(this.var_402 == this.const_2070)
                  {
                  ...
                  else if(this.var_402 == this.const_2075)
                  {
                  ...
                  else if(this.var_402 == this.const_2069)
                  {
                  ...
                  else if(this.var_402 == this.const_2072)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  ...
                  else if(this.var_402 == this.const_2073)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_182,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_402 == this.const_2071)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_2074.replace("%campaign%",this.var_182);
            this.setDecoImage(_loc5_,this.const_1795);
            _loc2_ = _loc2_.replace("%campaign%",this.var_182);
            this.setDecoImage(_loc2_,this.const_1794);
            if(_loc3_)
            {
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this._inventory)
         {
            if(this.var_1444 != 0)
            {
               this._inventory.toggleInventoryPage(this.var_1444 == 1 ? "null" : InventoryCategory.const_138);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_681,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1443.push(new ImageDownloader(this,_assets,this.var_182,this.var_1442,param1,param2));
            return;
         }
