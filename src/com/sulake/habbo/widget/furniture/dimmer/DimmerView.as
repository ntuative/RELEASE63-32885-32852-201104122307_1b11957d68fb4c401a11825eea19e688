package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_686:DimmerViewColorGrid;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_73,HabboWindowStyle.const_29,0 | 0,new Rectangle(const_1280,WINDOW_INITIAL_Y,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_686 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
         ...
         this.var_272 = ITabContextWindow(this._window.findChildByName("tab_context"));
         this.selectTab(this._widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < this.var_272.numTabItems)
         {
            _loc6_ = this.var_272.getTabItemAt(_loc2_);
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1577 = _loc2_.light;
         if(this.var_468 != null)
         {
            this.var_468.setValue(this.var_1577);
         }
         this.var_559 = this.colors.indexOf(_loc2_.color);
         if(this.var_686 != null)
         {
            this.var_686.setSelectedColorIndex(this.var_559);
         }
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = this.var_272.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            this.var_272.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = this.var_272.selector.getSelected();
         return this.var_272.selector.getSelectableIndex(_loc1_);
      }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1578 = XML(_loc1_.content);
         return this.var_1578;
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_686 != null)
         {
            this.var_686.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
