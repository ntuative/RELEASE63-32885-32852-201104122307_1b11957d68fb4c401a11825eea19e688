package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         {
            _loc3_ = param1.buildFromXML(this.var_1818) as IWindowContainer;
            ...
            _loc3_.width = this.var_636.width;
            _loc3_.height = this.var_636.height;
            this.var_514.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(this.var_636.width,this.var_636.height,true,0);
               _loc4_.bitmap.copyPixels(this.var_636,this.var_636.rect,new Point(0,0));
            }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_1818 = XML(_loc2_.content);
         _loc3_ = BitmapDataAsset(param1.getAssetByName("dimmer_color_frame"));
         this.var_636 = BitmapData(_loc3_.content);
