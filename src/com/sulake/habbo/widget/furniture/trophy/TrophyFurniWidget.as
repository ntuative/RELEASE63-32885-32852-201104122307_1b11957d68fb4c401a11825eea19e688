package com.sulake.habbo.widget.furniture.trophy
{
   ...
   public class TrophyFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1442:Array = new Array("trophy_bg_gold","trophy_bg_silver","trophy_bg_bronze");
      
      private static const const_1441:Array = new Array(4293707079,4291411404,4290279476);
      ...
      private function showInterface() : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.color = const_1441[this._color];
         }
         ...
         _loc8_ = assets.getAssetByName(const_1442[this._color]) as BitmapDataAsset;
