package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_1625:BitmapData;
      ...
      {
         this.var_562 = param1.volume;
         if(this.var_891 != null)
         {
            this.var_891.setValue(this.var_562);
         }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_562 == 0)
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1624);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1625);
         }
      }
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_562 == 1)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1622);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1623);
         }
      }
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_843);
         }
         else
         {
