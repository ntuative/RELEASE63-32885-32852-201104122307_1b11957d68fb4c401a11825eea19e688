package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2079:int = 1000;
      ...
      {
         super();
         this.var_215 = new Timer(this.const_2079);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_183.isActive)
         {
            ...
            this.var_971.width = _loc2_ * this.var_306;
         }
         else
         {
            this.var_971.width = 0;
            this.var_215.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_782 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_782 == null)
            {
               return;
            }
         ...
         if(!this.var_183.isActive)
         {
            this.var_782.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_782.caption = "${widgets.memenu.effects.active.timeleft}";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.setTimeLeft();
         this.var_971 = this._window.findChildByName("loader_bar");
         if(this.var_971 != null)
         {
            this.var_306 = this.var_971.width;
            this.var_215.start();
            this.onUpdate();
         }
