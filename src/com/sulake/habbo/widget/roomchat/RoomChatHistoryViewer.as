package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private var var_186:RoomChatHistoryPulldown;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_1074 = false;
         this._widget = param1;
         this.var_186 = new RoomChatHistoryPulldown(param1,param2,param3,param4);
         this.var_186.state = RoomChatHistoryPulldown.const_273;
         ...
         this.var_50 = param2.createWindow("chatscroller","",HabboWindowType.const_1263,HabboWindowStyle.const_44,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_186.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_273);
      }
      ...
      {
         return !!this.var_446 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_186.state == RoomChatHistoryPulldown.const_414 || this.var_186.state == RoomChatHistoryPulldown.const_612;
      }
      ...
      {
         if(!this.var_446 && !this.var_1760)
         {
            this.var_446 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_186.state = RoomChatHistoryPulldown.const_414;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_50 != null)
         {
            ...
            if(param2)
            {
               this.var_50.scrollV = this.var_660;
            }
         }
         if(this.var_186 != null)
         {
            this.var_186.containerResized(param1);
         }
      }
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_445 > 0 && param2)
         {
            if(this.var_1909)
            {
               if(Math.abs(param1 - this.var_445) <= const_1094)
               {
                  return;
               }
               this.var_1909 = false;
            ...
            if(this.var_446)
            {
               ...
               _loc5_ = (param1 - this.var_445) / this.var_50.height;
               _loc3_ = this.var_660 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - this.var_445;
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_50.scrollV < 1 - const_1400 / this.var_50.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_1908)
               {
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_50 != null)
         {
            this.var_660 = this.var_50.scrollV;
         }
         if(this.var_50 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_660 - this.var_50.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
