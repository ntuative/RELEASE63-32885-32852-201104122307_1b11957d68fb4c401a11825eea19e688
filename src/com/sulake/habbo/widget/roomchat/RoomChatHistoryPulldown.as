package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private var var_2720:BitmapData;
      
      private var var_1929:BitmapData;
      
      private var var_1930:BitmapData;
      
      private var var_2718:BitmapData;
      
      private var var_2721:BitmapData;
      
      private var var_2722:int = 30;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_41 = param3;
         this.var_2723 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1928 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2720 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1929 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1930 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2718 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2721 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_78 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_312,HabboWindowStyle.const_29,HabboWindowParam.const_61,new Rectangle(0,0,param3.width,param3.height - const_86),null,0,0) as IBitmapWrapperWindow;
         this.var_41.addChild(this.var_78);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_73,HabboWindowStyle.const_29,0 | 0,new Rectangle(0,this.var_41.height - const_86,param3.width,const_86),null,0) as IWindowContainer;
         this.var_41.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_580,HabboWindowStyle.const_44,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_86),null,0) as IRegionWindow;
         ...
         if(_loc6_ != null)
         {
            ...
            _loc6_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.method_10);
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_612:
               this.var_78.blend += param1 / const_1016;
               this._window.blend += param1 / const_1016;
               if(this._window.blend >= 1)
               {
                  this.state = const_414;
               }
               break;
            case const_1030:
               this.var_78.blend -= param1 / const_1015;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(this._region != null)
         {
            ...
            this._region.width = this.var_41.width - this.var_2722;
         }
         if(this.var_78 != null)
         {
            this.var_78.rectangle = this.var_41.rectangle;
            this.var_78.height -= const_86;
         }
         this.buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2719 == this._window.width)
         {
            return;
         }
         this.var_2719 = this._window.width;
         ...
         if(_loc2_ != null && _loc5_ != null)
         {
            ...
            _loc2_.bitmap = this.var_1929;
            _loc2_.disposesBitmap = false;
            this.var_2722 = this._window.width - _loc2_.x;
         }
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_2723,_loc7_);
            ...
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1928,_loc8_);
            ...
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1928,_loc9_);
         ...
         this.var_78.bitmap = this.var_2721;
