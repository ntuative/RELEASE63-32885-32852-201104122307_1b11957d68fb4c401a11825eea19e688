package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputViewOld
   {
      ...
      private static const const_1355:int = 11;
      
      private static const const_632:int = 18;
      
      private static const const_996:int = 16;
      
      private static const const_1354:int = 20;
      ...
      public function RoomChatInputViewOld(param1:RoomChatInputWidgetOld, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         this.var_2164 = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
      ...
      private function createWindow() : void
      {
         ...
         _loc6_.addEventListener(WindowEvent.const_99,this.onInputChanged);
         this._window.addEventListener(WindowEvent.const_260,this.onWindowMoved);
         this.var_1348 = true;
         this.var_510 = "";
         this.refreshView();
      }
      ...
      private function refreshView() : void
      {
         ...
         this._window.width = _loc1_.width + const_632 + const_996;
         _loc1_.x = const_632;
         _loc1_.y = const_1355;
      }
      ...
      {
         this.var_306 = param1 - (const_632 + const_996);
      ...
      private function onWindowMoved(param1:WindowEvent) : void
      {
         ...
         this.setMaxWidth(this._window.context.getDesktopWindow().width - this._window.x - const_1354);
      }
