package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private static var var_1429:uint = 13232628;
      
      private static var var_1767:uint = 11129827;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1768 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1059 || param1 == ChangeUserNameResultMessageEvent.var_1062)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1165 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1165.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1429;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(!this.var_1428)
         {
            if(param1.type == WindowEvent.const_99)
            {
