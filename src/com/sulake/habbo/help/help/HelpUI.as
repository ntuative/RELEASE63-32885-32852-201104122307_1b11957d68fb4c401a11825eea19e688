package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      {
         this.var_354 = this._defaultViewId;
         ...
         this.var_115.add(HabboHelpViewEnum.const_1532,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_115.add(HabboHelpViewEnum.const_208,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_115.add(HabboHelpViewEnum.const_491,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_115.add(HabboHelpViewEnum.const_347,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_115.add(HabboHelpViewEnum.const_284,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_115.add(HabboHelpViewEnum.const_363,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_115.add(HabboHelpViewEnum.const_775,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_115.add(HabboHelpViewEnum.const_226,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_115.add(HabboHelpViewEnum.const_1152,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_115.add(HabboHelpViewEnum.const_1252,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_115.add(HabboHelpViewEnum.const_955,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_489.length == 0 || param1 != this.var_354)
            {
               this.var_489.push(this.var_354);
            }
         }
         this.var_354 = param1;
         ...
         if(_loc3_ == null)
         {
            Logger.log("* No view controller found for " + this.var_354);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            ...
            case CallForHelpResultEnum.const_1080:
               this.showUI(HabboHelpViewEnum.const_1252);
               break;
            case CallForHelpResultEnum.const_1253:
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_115.getValue(HabboHelpViewEnum.const_208) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_495));
      }
      ...
      {
         return this.var_115.getValue(this.var_354);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2270 = this._window.width - _loc3_.width;
         this.var_2271 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2271;
         this._window.width = _loc1_.width + this.var_2270;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_489.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_354 == HabboHelpViewEnum.const_208)
         {
            return;
         }
         if(this.var_603.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_603.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_603.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_355.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_603[1],this.var_603[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_603[0],this.var_603[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_354 == HabboHelpViewEnum.const_208 || this.var_489.length == 0)
         {
            return;
         }
         if(this.var_355 == null)
         {
            ...
            this.var_355 = this._windowManager.buildFromXML(XML(_loc2_.content)) as IWindowContainer;
            _loc3_ = this.var_355.findChildByName("back_image");
            if(_loc3_ != null)
            {
            ...
            _loc4_ = this.var_355.findChildByName("back_text");
            if(_loc4_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_355 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_355 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_355 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
