package com.sulake.habbo.help
{
   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      {
         return this._notifications[this.var_1379];
      }
      ...
      public function dispose() : void
      {
         if(this.var_133)
         {
            ...
            this.var_133.toolbar.events.removeEventListener(HabboToolbarEvent.const_37,this.onToolbarClicked);
            this.var_133.toolbar.events.removeEventListener(HabboToolbarEvent.const_846,this.onToolbarResized);
            this.var_133 = null;
         }
         ...
         {
            this.var_728.stop();
            this.var_728.removeEventListener(TimerEvent.TIMER,this.onReminderTimer);
            this.var_728 = null;
         }
      ...
      public function showWelcomeScreen(param1:Boolean) : void
      {
         ...
         this.var_133.toolbar.events.addEventListener(HabboToolbarEvent.const_37,this.onToolbarClicked);
         this.var_133.toolbar.events.addEventListener(HabboToolbarEvent.const_846,this.onToolbarResized);
         var _loc4_:int = parseInt(this._config.getKey("welcome.screen.delay","5000"));
         this.var_728 = new Timer(_loc4_);
         this.var_728.addEventListener(TimerEvent.TIMER,this.onReminderTimer);
         this.var_728.start();
      }
      ...
      public function onReminderTimer(param1:TimerEvent) : void
      {
         ...
         this.var_233.y = this.var_133.toolbar.getIconLocation(this.current.targetIconId) - this._window.height / 2;
      ...
      private function initializeWindow() : void
      {
         ...
         _loc4_.content.setParamFlag(WindowParam.const_333,false);
         _loc4_.height -= 20;
      ...
      {
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_98,this.current.targetIconId);
      ...
      private function closeWindow() : void
      {
         ...
         if(this.var_1379 < this._notifications.length - 1)
         {
            ++this.var_1379;
         }
         else
