package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         this.var_1053 = param2 - _loc6_.textHeight;
         ...
         _loc9_.graphics.lineTo(0,this.var_1053);
         _loc10_ = 0;
         while(_loc10_ <= 5)
         {
            _loc4_ = (this.var_1053 - 1) / 5 * _loc10_;
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - this.var_1296,(param2 - this.var_1053) / 2));
         return _loc3_;
      }
      
      private function getX(param1:int) : Number
      {
         return this.var_1296 + this.var_1296 / -this.var_2931 * this._x[param1];
      }
      
      private function getY(param1:int) : Number
      {
         return this.var_1053 - this.var_1053 / this.var_689 * this.var_154[param1];
      }
