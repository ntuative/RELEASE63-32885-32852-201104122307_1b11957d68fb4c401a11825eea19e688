package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_2051:int = 10;
      ...
      private const const_1806:uint = 4.294967295E9;
      
      private const const_2052:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1630 = _loc1_.stuffTypes;
            this.var_748 = _loc1_.boxTypes;
            this.var_749 = _loc1_.ribbonTypes;
            this.var_1150 = this.var_1630[0];
            this.var_361 = this.var_748[0];
            this.var_360 = this.var_749[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_360 < 0)
         {
            this.var_360 = this.var_749.length - 1;
         }
         if(this.var_360 > this.var_749.length - 1)
         {
            this.var_360 = 0;
         }
         if(this.var_361 < 0)
         {
            this.var_361 = this.var_748.length - 1;
         }
         if(this.var_361 > this.var_748.length - 1)
         {
            this.var_361 = 0;
         }
         var _loc1_:int = this.var_748[this.var_361] * 1000 + this.var_749[this.var_360];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_92.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1150,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1413 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1630;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1150);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_748[this.var_361]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_749[this.var_360]);
         this._catalog.purchaseProductAsGift(this.var_1411,this.var_92,this.var_1412,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this.var_1411,this.var_92.offerId,this.var_1412);
               this.dispose();
               break;
            case "cancel_button":
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_99:
               _loc3_ = param1.window as ITextFieldWindow;
               if(_loc3_ == null)
               {
                  return;
               }
               if(this.var_2395 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in this.var_237)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= this.const_2051)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2395 = _loc3_.text;
               break;
            case WindowMouseEvent.const_43:
               ...
               break;
            case WindowKeyboardEvent.const_407:
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_623 == null)
         {
            this.var_623 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_623.procedure = this.suggestionsEventHandler;
         }
         if(this.var_261 == null || this.var_623 == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_623.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_2052;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1805) : uint(this.const_1806);
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1150;
               }
            }
            _loc4_++;
         }
