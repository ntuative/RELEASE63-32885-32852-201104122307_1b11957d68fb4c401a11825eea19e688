package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_592 != const_967;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1632 != RecyclerStatusMessageEvent.const_1132;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_592 == const_437;
      }
      ...
      {
         this.var_592 = const_968;
         this.var_114 = new Array(const_189);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1632)
         {
            case RecyclerStatusMessageEvent.const_1758:
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1132:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1097:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1543:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_114.length < const_189)
         {
            return false;
         }
         var _loc1_:int = 0;
