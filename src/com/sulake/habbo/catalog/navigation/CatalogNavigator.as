package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2935:String = "magic.credits";
      
      private var var_2895:String = "magic.pixels";
      
      private var var_2896:String = "catalog.page.club";
      ...
      {
         this.openPage(this.var_2895);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_2896,true);
      }
