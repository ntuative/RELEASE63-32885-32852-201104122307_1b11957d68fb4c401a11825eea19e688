package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         _loc1_.addEventListener(WindowEvent.const_99,this.onTextWindowEvent);
         ...
         this.var_485 = this.getPetTypeIndexFromProduct(_loc2_.localizationId);
         if(this.var_485 < 8)
         {
            return false;
         }
         this.var_2198 = _loc2_.localizationId;
         this.updateAvailableBreeds(_loc2_.localizationId);
         if(this.var_214 != null && this.var_214.length > 0)
         {
            this.var_346 = this.var_214[0];
         }
         else
         {
            this.var_346 = -1;
         }
         this._offers.add(this.var_485,_loc2_);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_214 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1286 && _loc2_ < this.var_214.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_485,this.var_214[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_214 != null && this.var_214.length > 0)
         {
            ...
            this.var_346 = this.var_214[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_485,this.var_346),this.getRaceLocalizationKey(this.var_485,this.var_346));
            }
         }
         return this.getRaceLocalizationKey(this.var_485,this.var_346);
      }
      ...
      private function updateImage() : void
      {
         ...
         if(_loc1_ == null || this.var_346 < 0)
         {
            return;
         }
         var _loc2_:int = this.var_485;
         var _loc3_:int = this.var_346;
      ...
      private function getPurchaseParameters() : String
      {
         ...
         var p:String = this._name + String.fromCharCode(10) + this.var_346 + String.fromCharCode(10) + this.addZeroPadding(color.toString(16).toUpperCase(),6);
         return p;
      }
