   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_736,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_280,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_896,this.deActivateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_187,this.deActivateScrollbar);
         }
      }
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         while(_loc2_ < 3)
         {
            if(this.var_773 >= 0 && this.var_773 < page.offers.length)
            {
               _loc3_ = page.offers[this.var_773];
               this.loadGraphics(_loc3_);
               _loc3_.productContainer.grid = this;
            }
            ++this.var_773;
            if(this.var_773 >= page.offers.length)
            {
               this.resetTimer();
               break;
            }
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         if(param1.pricingModel == Offer.const_517)
         {
            ++this.var_1803;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_1803);
         }
      }
