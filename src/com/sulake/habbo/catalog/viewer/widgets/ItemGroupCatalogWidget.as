package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         var _loc2_:Offer = this.var_213[this.var_558][this.var_841];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_558 = var_572.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_558];
         var _loc3_:Array = this.var_213[this.var_558] as Array;
      ...
      override protected function populateItemGrid() : void
      {
         ...
         {
            if(this.var_841 < _loc1_.length)
            {
               _loc2_ = _loc1_[this.var_841] as Offer;
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_405 || _loc1_.pricingModel == Offer.const_379)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_71 || _loc3_.productType == ProductTypeEnum.const_79)
                  {
