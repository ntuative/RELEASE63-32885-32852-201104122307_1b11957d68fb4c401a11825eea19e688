package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_943.removeEventListener(WindowKeyboardEvent.const_177,this.windowKeyEventProcessor);
            this.var_943 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_943 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_943 != null)
         {
            this.var_943.addEventListener(WindowKeyboardEvent.const_177,this.windowKeyEventProcessor);
         }
         return true;
      }
