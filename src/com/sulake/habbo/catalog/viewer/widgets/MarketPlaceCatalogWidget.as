package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_1771:int = 2;
      
      private const const_2040:int = 40;
      
      private const const_2039:int = 10;
      
      private var var_711:Array;
      
      private var var_1349:MarketPlaceOfferData;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_482)
         {
            this.var_482.removeEventListener(TimerEvent.TIMER,this.onPopulationTimer);
            this.var_482 = null;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_586)
         {
            ...
            this.var_586 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!this.var_586)
         {
            return;
         ...
         this.updateStatusDisplay(this.const_1771,_loc2_.length);
         if(!this.var_482)
         {
            this.var_482 = new Timer(25);
            this.var_482.addEventListener(TimerEvent.TIMER,this.onPopulationTimer);
         }
         this.var_1093 = 0;
         this.populateList();
         this.var_482.start();
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !this._itemList || !this.var_586 || !this.marketPlace.localization)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_586.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_1770);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
      ...
      private function onWidgetEvent(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowEvent.const_99)
         {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1349.offerId);
            }
            return;
         }
         if(param1.type == WindowEvent.const_56)
