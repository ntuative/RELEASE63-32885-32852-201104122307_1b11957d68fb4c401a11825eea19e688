package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1533:String = "FollowFriendFailedMessageParser";
      ...
      private var _floorType:String = "FollowFriendFailedMessageParser";
      ...
      override public function init() : Boolean
      {
         ...
         if(_loc1_ != null)
         {
               ...
               switch(_loc4_.furnitureData.name)
               {
                  ...
                  case "landscape":
                     for each(_loc11_ in this.var_178.landscapes.pattern)
                     {
                        ...
                        {
                           this.var_1014.push(_loc7_);
                           _loc8_ = true;
                        }
                     }
                     if(_loc8_)
                     {
                        this.var_1532.push(_loc2_);
                     }
                     else
                     {
            ...
            events.dispatchEvent(new CatalogWidgetUpdateRoomPreviewEvent(this._floorType,this.var_1533,this.var_1529,64));
            return true;
         }
         return false;
      }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1530[this.var_454];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_floor_color_next":
               ...
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1531[this.var_453];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = this.var_1532[this.var_452];
               if(_loc3_ != null)
               {
      ...
      private function updateConfiguration() : void
      {
         ...
         for each(_loc1_ in this.var_178.floors.pattern)
         {
            if(_loc1_.@id == _loc5_)
            {
               _loc11_ = _loc1_.children()[this.var_537];
               if(_loc11_ != null)
               {
         ...
         _loc6_ = this.var_1531[this.var_453];
         if(_loc6_ != null)
         {
         ...
         var _loc7_:String = this.var_1014[this.var_452];
         for each(_loc1_ in this.var_178.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
               _loc13_ = _loc1_.children()[this.var_536];
               if(_loc13_ != null)
               {
         ...
         _loc8_ = this.var_1532[this.var_452];
         if(_loc8_ != null)
         {
         ...
         switch(param1)
         {
            case const_223:
               ...
               for each(_loc8_ in this.var_178.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     this.var_1015 = _loc8_.children().length();
                  }
               }
            ...
            case const_222:
               ...
               for each(_loc9_ in this.var_178.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     this.var_1011 = _loc9_.children().length();
                  }
               }
            ...
            case TYPE_LANDSCAPE:
               ...
               if(this.var_452 < 0)
               {
                  this.var_452 = this.var_1014.length - 1;
               }
               if(this.var_452 >= this.var_1014.length)
               {
                  this.var_452 = 0;
               }
               this.var_536 = 0;
               this.var_1013 = 0;
               _loc7_ = this.var_1014[this.var_452];
               for each(_loc10_ in this.var_178.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     this.var_1013 = _loc10_.children().length();
                  }
               }
