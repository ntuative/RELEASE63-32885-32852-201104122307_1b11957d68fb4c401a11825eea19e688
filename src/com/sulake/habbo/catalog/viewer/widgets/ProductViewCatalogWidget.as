package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1214 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_88 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1905 = new Point(this.var_88.x,this.var_88.y);
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_1214.text = _loc5_;
         this.var_1001.height = this.var_1001.textHeight + 5;
         this.var_1214.y = this.var_1001.y + this.var_1001.height;
         this.var_1214.height = Math.max(130,this.var_1214.textHeight + 5);
                     ...
                     case ProductTypeEnum.const_203:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_340,AvatarAction.const_553);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2666)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2666 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_88 != null && true)
         {
            ...
            this.var_88.x = this.var_1905.x;
            this.var_88.y = this.var_1905.y;
            if(param3 != null)
            {
