package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1769:String = "ctlg_";
       
      
      protected var var_1314:XML;
      ...
      private var var_530:EventDispatcher;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_530 = new EventDispatcher();
      ...
      {
         var _loc2_:String = const_1769 + param1;
         ...
         this.var_1314 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_1314) as IWindowContainer;
         if(this._window == null)
         {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1655:
               if(this.var_1215 == null)
               {
                  ...
                  this.var_36.push(this.var_1215);
               }
               break;
            case CatalogWidgetEnum.const_1501:
            ...
            case CatalogWidgetEnum.const_1487:
               ...
               break;
            case CatalogWidgetEnum.const_1590:
            ...
            case CatalogWidgetEnum.const_1519:
               ...
               break;
            case CatalogWidgetEnum.const_1498:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_530.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_530 != null)
         {
            return this.var_530.dispatchEvent(param1);
         }
         return false;
      }
