package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_1007:String = "bg";
      ...
      {
         this._view.getChildByName(const_1007).style = HabboWindowStyle.const_29;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_1007).style = 3;
      }
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_25 && this.var_601 != null && this.var_601 == param2)
         {
         ...
         else if(param1.type == WindowMouseEvent.const_178)
         {
            this.var_601 = null;
         }
      }
