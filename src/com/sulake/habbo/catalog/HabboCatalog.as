package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_222:PurchaseConfirmationDialog;
      ...
      private var var_2350:Boolean = true;
      
      private var var_1726:Boolean = false;
      
      private var var_2352:GiftWrappingConfiguration;
      
      private var var_1142:ClubGiftController;
      
      private var var_497:ClubBuyController;
      
      private var var_743:Map;
      
      private var var_1143:Boolean = false;
      
      private var var_931:IPurchasableOffer;
      
      private var var_1397:IDragAndDropDoneReceiver;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.events.removeEventListener(RoomSessionEvent.const_93,this.onRoomSessionEvent);
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         if(param1 is Offer)
         {
            if(this.var_222 == null)
            {
               this.var_222 = new PurchaseConfirmationDialog(this._localization);
            }
            _loc5_ = [];
            ...
            this.var_222.showOffer(this,param1,param2,param3,_loc5_);
            if(param4)
            {
         ...
         {
            this.var_497.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_358.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      {
         var _loc2_:Array = this.var_743.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_105.getActivityPointsForType(Purse.const_207)));
         var _loc1_:int = 0;
      ...
      {
         this.var_157.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_123,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(this.var_157 != null && _loc2_)
         {
            this.var_157.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_57,HabboToolbarIconEnum.CATALOGUE,this._mainContainer));
         }
         if(this.mainWindowVisible())
         {
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_358 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_85:
               this.var_1726 = param1.session.isPrivateRoom;
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1142 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_497 == null)
         {
            this.var_497 = new ClubBuyController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_358.buildCatalogIndex(_loc2_);
         if(this.var_742 && this.var_742 != "")
         {
            this.var_358.openPage(this.var_742);
            this.var_742 = "";
            this.var_930 = -1;
         }
         else if(this.var_930 > -1)
         {
            this.var_358.openPageById(this.var_930,this.var_1725);
            this.var_930 = -1;
            this.var_1725 = -1;
            this.var_742 = "";
         }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2351 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1165);
         }
         this.var_2351 = false;
         if(this.var_299 != null)
         {
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_66,this.var_105.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2350 && this._soundManager != null)
         {
         ...
         if(_loc2_.type == Purse.const_207)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1142.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2352 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onIsOfferGiftable(param1:IsOfferGiftableMessageEvent) : void
      {
         ...
         if(this.var_222 != null)
         {
            this.var_222.onIsOfferGiftable(param1.getParser());
         }
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_743.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_743.add(_loc2_.productCode,_loc3_.slice());
      ...
      public function requestSelectedItemToMover(param1:IDragAndDropDoneReceiver, param2:Offer) : void
      {
         ...
         _loc6_ = this._roomEngine.method_3(-param2.offerId,_loc4_,_loc3_.productClassId,_loc3_.extraParam.toString());
         if(_loc6_)
         {
            this.var_931 = param2;
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         if(this.var_1143 && param1.type == RoomEngineObjectEvent.const_176)
         {
            this.resetPlacedOfferData();
            if(this.var_931 == null || !param1.placedInRoom)
            {
               this.resetObjectMover();
               return;
            }
            this.var_85 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_931);
            _loc2_ = this.var_1397;
            this.resetObjectMover();
            if(_loc2_ != null)
            {
            ...
            _loc4_ = this.var_931.productContainer.firstProduct;
            ...
            if(_loc5_)
            {
               _loc5_.getModelController().setNumber(RoomObjectVariableEnum.const_300,0.5);
            }
         }
      }
      ...
      private function onItemAddedToInventory(param1:HabboInventoryItemAddedEvent) : void
      {
         ...
         if(this.var_85 && this.var_85.productClassId == param1.classId)
         {
            if(this.var_85.roomCategory == this._roomEngine.activeRoomCategory && this.var_85.roomId == this._roomEngine.activeRoomId)
            {
               ...
               if(param1.category == FurniCategory.const_344 || param1.category == FurniCategory.const_305 || param1.category == FurniCategory.const_309)
               {
