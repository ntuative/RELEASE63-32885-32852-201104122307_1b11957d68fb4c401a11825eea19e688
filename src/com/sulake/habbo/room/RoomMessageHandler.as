package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private function onFloorHeightMap(param1:IMessageEvent) : void
      {
         ...
         if(this.var_830.objectData)
         {
            this.addActiveObject(_loc4_,_loc5_,this.var_830.objectData);
            this.var_830.objectData = null;
         }
         else
         {
            this.var_830.floorReady = true;
         }
      }
      ...
      private function onObjectInject(param1:IMessageEvent) : void
      {
         ...
         var _loc5_:int = _loc3_.roomCategory;
         var _loc6_:ObjectMessageData = _loc3_.data;
         if(this.var_830.floorReady)
         {
            this.addActiveObject(_loc4_,_loc5_,_loc6_);
         }
         else
         {
            this.var_830.objectData = _loc6_;
         }
      }
      ...
      private function onUserUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:Number = _loc6_.getNumber(RoomVariableEnum.const_886);
         var _loc8_:int = 0;
         while(_loc8_ < _loc3_.userUpdateCount)
         {
            ...
            if(_loc9_ != null)
            {
               ...
               this.var_12.include(_loc4_,_loc5_,_loc9_.id,_loc11_,_loc13_,_loc12_,_loc9_.dirHead);
               _loc14_ = "null";
               _loc15_ = "";
      ...
      private function onSlideUpdate(param1:IMessageEvent) : void
      {
         ...
         if(param1 is SlideObjectBundleMessageEvent)
         {
            ...
            if(_loc2_.avatar != null)
            {
               ...
               this.var_12.include(_loc3_,_loc4_,_loc9_.id,_loc9_.loc,_loc9_.target);
               switch(_loc9_.moveType)
               {
                  case SlideObjectMessageData.const_1187:
                     _loc10_ = "mv";
                     break;
                  case SlideObjectMessageData.const_1138:
                     _loc10_ = "std";
               }
      ...
      private function onTypingStatus(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:RoomObjectAvatarTypingUpdateMessage = new RoomObjectAvatarTypingUpdateMessage(_loc3_.method_2);
         this.var_12.updateObjectUserState(_loc3_.roomId,_loc3_.roomCategory,_loc3_.userId,_loc4_);
      }
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_1107,_loc3_.status);
         }
      }
