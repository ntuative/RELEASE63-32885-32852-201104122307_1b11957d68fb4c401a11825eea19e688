package com.sulake.habbo.room.object.visualization.data
{
   public class AnimationFrame
   {
      ...
      private static const const_1357:int = 3000;
      ...
      public static function allocate(param1:int, param2:int, param3:int, param4:int, param5:int, param6:Boolean, param7:int = -1, param8:int = 0) : AnimationFrame
      {
         ...
         _loc9_.var_2528 = param6;
         if(param4 < 1)
         {
            param4 = 1;
         }
         _loc9_.var_2243 = param4;
         if(param5 < 0)
         {
            param5 = const_456;
         }
         _loc9_.var_957 = param5;
         _loc9_.var_1801 = param5;
         if(param7 >= 0)
         {
            _loc9_.var_2526 = param7;
            _loc9_.var_2527 = param8;
         }
         return _loc9_;
      }
      ...
      public function set remainingFrameRepeats(param1:int) : void
      {
         ...
         if(this.var_957 > 0 && param1 > this.var_957)
         {
            param1 = this.var_957;
         }
