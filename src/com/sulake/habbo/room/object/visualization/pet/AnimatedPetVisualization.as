package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1372:String = "head";
      
      private static const const_633:int = 1;
      
      private static const const_1000:int = 1000;
      
      private static const const_1371:String = "pet_experience_bubble_png";
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1371) as BitmapDataAsset;
            if(_loc3_ != null)
            {
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2572)
            {
               this.var_2572 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_225);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_137);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_225);
            if(!isNaN(_loc6_))
            {
            ...
            this.var_1640 = _loc3_.getNumber(RoomObjectVariableEnum.const_395) > 0;
            ...
            this.var_1456 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2193 = _loc3_.getNumber(RoomObjectVariableEnum.const_866);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_674);
            if(_loc9_ != this.var_1807)
            {
               this.var_1807 = _loc9_;
               this.var_2571 = this.var_1807.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_370 != null)
         {
            ...
            if(this.var_1456 > 0)
            {
               ...
               {
                  this.var_370.alpha = int(Math.sin(_loc2_ / const_1000 * 0) * 255);
      ...
      private function validateActions(param1:String, param2:String) : void
      {
         ...
         if(param1 != this.var_250)
         {
            ...
            this.setAnimationForIndex(const_1370,_loc3_);
         }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2571);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_633)
         {
            ...
            {
               if(param2 >= FurnitureVisualizationData.const_574.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_574[param2];
               if(_loc4_ == 1)
               {
      ...
      private function isHeadSprite(param1:int) : Boolean
      {
         ...
         {
            if(this._animationData.getTag(var_90,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1372)
            {
               this.var_964[param1] = true;
            }
            else
            {
               this.var_964[param1] = false;
            }
         }
         return this.var_964[param1];
      }
   }
}
