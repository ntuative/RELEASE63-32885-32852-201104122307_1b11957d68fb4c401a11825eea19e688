package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlane
   {
      ...
      {
         if(param1 != this.var_2706)
         {
            if(!param1)
            {
               this.var_318.assign(this.var_814);
               this.var_319.assign(this.var_813);
            }
            else
            {
               this.var_318.assign(this.var_814);
               this.var_318.mul(this.var_813.length / this.var_814.length);
               this.var_319.assign(this.var_813);
               this.var_319.mul(this.var_814.length / this.var_813.length);
            }
            this.var_1637 = -1;
      ...
      private function needsNewTexture(param1:IRoomGeometry) : Boolean
      {
         ...
         if(this.var_263 > 0 && this._height > 0)
         {
            if(_loc3_ == null)
            {
               return true;
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || this.var_95 == null && this.var_1087 != null || this.var_318 == null || this.var_319 == null || this.var_581 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != this.var_1637)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != this.var_1515 || _loc4_.y != this.var_2490 || _loc4_.z != this.var_2495 || param1.scale != this.var_2492))
            {
               this.var_1515 = _loc4_.x;
               this.var_2490 = _loc4_.y;
               this.var_2495 = _loc4_.z;
               ...
               _loc7_ = _loc6_.z;
               _loc8_ = Math.max(this.var_149.z - _loc7_,this.var_110.z - _loc7_,this.var_84.z - _loc7_,this.var_111.z - _loc7_);
               this.var_2144 = _loc8_;
