package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private function getNewPoint(param1:Number, param2:int) : Point
      {
         ...
         var _loc6_:Number = this.var_1241[param2];
         if(param1 == 32)
         {
            _loc7_ = const_1018;
         }
         ...
         if(int(_loc9_) == 0)
         {
            this.var_1241[param2] = this.getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         this.var_1239.push(const_1417);
         this.var_1239.push(const_1416);
         this.var_1241 = new Array();
         this.var_1241.push(this.getRandomAmplitudeFactor());
         this.var_1241.push(this.getRandomAmplitudeFactor());
      }
