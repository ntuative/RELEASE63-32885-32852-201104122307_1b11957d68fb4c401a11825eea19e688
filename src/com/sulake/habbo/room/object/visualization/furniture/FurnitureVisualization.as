package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1761:Number = Math.sqrt(0.5);
       
      
      private var _direction:int;
      
      private var var_2335:Number = NaN;
      ...
      private var var_1710:Boolean = true;
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(param4)
         {
            this.var_1387 |= this.updateAnimation(_loc6_);
         }
         else
         {
            _loc7_ = this.updateAnimation(_loc6_) | this.var_1387;
            this.var_1387 = 0;
         }
         if(_loc5_ || _loc7_ != 0)
         {
      ...
      private function updateSprite(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null && _loc3_ != null)
         {
            ...
            if(_loc5_ != null && _loc5_.asset != null)
            {
               ...
               _loc4_.clickHandling = this.var_2225;
            }
            else
            {
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_470 != _loc3_.getUpdateID() || param1 != var_90 || param2 != this.var_2335)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2334 = _loc3_.getNumber(RoomObjectVariableEnum.const_268);
            ...
            this.var_1134 = this.getAdClickUrl(_loc3_);
            if(this.var_1134 == null || this.var_1134.indexOf("http") != 0)
            {
               this.var_1134 = null;
            }
            this.var_2225 = this.var_1134 != null;
      ...
      {
         if(this.var_2336 != param2 || this.var_2337 != param1)
         {
            this.var_926 = [];
            this.var_927 = [];
            this.var_736 = [];
            ...
            this.var_2338 = this.getSize(param1);
      ...
      {
         this.var_678 = param1;
         this.var_1711 = this.var_678 - this.getAdditionalSpriteCount();
      }
      ...
      {
         if(this.var_730[param3] != null && !this.var_1710)
         {
      ...
      {
         if(this.var_735[param2] != null)
         {
            return this.var_735[param2];
         }
         if(this._data == null)
         {
