package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      {
         if(this.var_2309 == param1 && this.var_2308 == direction)
         {
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1118.indexOf(_loc2_) < 0)
            {
               this.var_1118.push(_loc2_);
            }
         }
         return _loc3_;
      }
      ...
      private function updateBorderData() : void
      {
         ...
         this.var_1695 = false;
         _loc5_ = 0;
         while(_loc5_ < this.var_417.length)
         {
            if(this.var_417[_loc5_] == true)
            {
               this.var_1695 = true;
            }
            _loc5_++;
      ...
      {
         var _loc2_:* = null;
         if(this.var_493 == 0 || this.var_612 == 0)
         {
            ...
            this.var_493 = _loc2_.getNumber(RoomObjectVariableEnum.const_313);
            this.var_612 = _loc2_.getNumber(RoomObjectVariableEnum.const_410);
         }
         this.var_417 = [];
         this.var_613 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_493 * 2 + this.var_612 * 2)
         {
            this.var_417.push(false);
            this.var_613.push(ShoreMaskCreatorUtility.const_81);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_69,getSize(param3),this.var_417,this.var_613,assetCollection);
      }
