package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneRasterizer implements IPlaneRasterizer
   {
      ...
      protected static const const_618:String = "FollowFriendFailedMessageParser";
      ...
      public function dispose() : void
      {
         ...
         if(this.var_143 != null)
         {
            ...
            {
               _loc2_ = this.var_143.getWithIndex(_loc1_) as Plane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_585 != null)
         {
            ...
            {
               _loc3_ = this.var_585.getWithIndex(_loc1_);
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      private function resetTextures() : void
      {
         ...
         {
            _loc2_ = this.var_195.getWithIndex(_loc1_) as PlaneTexture;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         return this.var_195.getValue(param1) as PlaneTexture;
      }
      ...
      protected function addPlane(param1:String, param2:Plane) : Boolean
      {
         ...
         if(this.var_143.getValue(param1) == null)
         {
            this.var_143.add(param1,param2);
            return true;
         }
         return false;
      }
      ...
      protected function getGeometry(param1:int, param2:Number, param3:Number) : IRoomGeometry
      {
         ...
         var _loc5_:IRoomGeometry = this.var_585.getValue(_loc4_);
         if(_loc5_ == null)
         {
            _loc5_ = new RoomGeometry(param1,new Vector3d(param2,param3),new Vector3d(-10,0,0));
            this.var_585.add(_loc4_,_loc5_);
         }
         return _loc5_;
      }
