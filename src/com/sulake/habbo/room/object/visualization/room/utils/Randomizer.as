package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_2003:int = 16777216;
      ...
      private var var_1907:int = 16777216;
      ...
      {
         var _loc1_:int = this.var_2920 * this.var_1906 + this.var_2921;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1907;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1907 * param2);
      }
   }
}
