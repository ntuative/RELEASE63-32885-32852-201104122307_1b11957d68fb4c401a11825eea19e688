package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_1732:XMLList;
      
      private var _offsetX:int;
      
      private var var_1105:int;
      
      private var var_2626:Vector3d;
      ...
      private var var_1196:Point = null;
      
      private var var_1487:LayoutRasterizerData = null;
      ...
      {
         if(param1 != this.var_983)
         {
            this.var_983 = param1;
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1487 = this.var_44.getValue(this.var_983);
         }
      }
      ...
      public function initialize(param1:XML) : void
      {
         ...
         this.var_2626 = new Vector3d(-0.5,0.5,0);
         this.var_984 = false;
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(this.var_2626);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
         _loc3_.x = Math.round(_loc3_.x);
         _loc3_.y = Math.round(_loc3_.y);
         this.var_1196.x = _loc3_.x;
         this.var_1196.y = _loc3_.y;
      }
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc3_:LayoutRasterizerData = this.var_44.getValue(this.var_983);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1841 = RoomObjectVariableEnum.const_1246;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1841 = RoomObjectVariableEnum.const_1222;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1195 + this._adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1195 + this._adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_44.getValue(this.var_983);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         if(param2 == this.var_2627 && param3 == this.var_2625)
         {
            return;
         }
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(this.var_1195 + this._adBgIndex);
            _loc5_ = param1.getSprite(this.var_1195 + this._adImgIndex);
         }
         ...
         {
            this.exchangeElementGraphics("billboard_img",this.var_1841);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_486;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = this.var_1487.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + this.var_1196.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + this.var_1196.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_440.indexOf(_loc10_) >= 0 && this.var_984)
            {
               param1 = this.var_440.indexOf(_loc10_);
               if(this.var_645[param1] != "")
               {
                  _loc9_ = this.var_710.getAsset(this.var_645[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(this.var_646[param1] != -1)
               {
                  param2.alpha = this.var_646[param1];
               }
               this.var_440.splice(param1,1);
               this.var_645.splice(param1,1);
               this.var_646.splice(param1,1);
      ...
      {
         this.var_984 = true;
         var _loc3_:int = this.var_440.indexOf(param1);
         if(_loc3_ < 0)
         {
