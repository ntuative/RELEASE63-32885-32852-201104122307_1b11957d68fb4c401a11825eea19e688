         ...
         if(this.var_641 != null)
         {
            ...
            if(_loc2_ != null)
            {
               if(!this.isStatic)
               {
                  ...
                  _loc3_ = Math.min(this.var_1182,this._extraItemOffsets.length);
                  _loc4_ = Math.max(this.var_1182,this._extraItemOffsets.length);
                  _loc5_ = Randomizer.getArray(this.var_1182,_loc4_);
                  _loc6_ = 0;
                  while(_loc6_ < _loc3_)
                  {
