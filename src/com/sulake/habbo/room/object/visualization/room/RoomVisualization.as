package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1630:int = 16777215;
      
      public static const const_1494:int = 13421772;
      
      private static const const_992:int = 16777215;
      
      private static const const_994:int = 13421772;
      
      private static const const_995:int = 10066329;
      
      private static const const_993:int = 10066329;
      
      public static const const_1632:int = 16777215;
      
      public static const const_1599:int = 13421772;
      
      public static const const_1697:int = 10066329;
      ...
      private var var_768:Rectangle = null;
      
      private var var_507:RoomPlaneBitmapMaskParser = null;
      ...
      private var var_2489:String = null;
      
      private var var_1170:uint = 16777215;
      
      private var var_2493:int = 255;
      ...
      private var var_1783:int = -1000;
      
      private const const_2066:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_507 = new RoomPlaneBitmapMaskParser();
         this.var_311["null"] = false;
         this.var_311["null"] = true;
         this.var_311["null"] = true;
         this.var_311["null"] = true;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_143 != null)
         {
            ...
            {
               _loc4_ = this.var_143[_loc3_] as RoomPlane;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_768 = super.boundingRectangle;
         }
         return new Rectangle(this.var_768.x,this.var_768.y,this.var_768.width,this.var_768.height);
      }
      ...
      protected function defineSprites() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:int = this.var_143.length;
         createSprites(_loc1_);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_143[_loc2_] as RoomPlane;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1224);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1179);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_1568)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_129,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_1783 + this.const_2066 && !_loc6_ && !_loc8_)
         {
            return;
         }
            ...
            while(_loc10_ < this.var_369.length)
            {
               ...
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1782)
                  {
                     ...
                     _loc15_ = uint((_loc14_ & 255) * this.var_2494 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2491 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2493 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1637)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1515 || _loc3_.y != this.var_2490 || _loc3_.z != this.var_2495 || param1.scale != this.var_2492))
            {
               this.var_1515 = _loc3_.x;
               this.var_2490 = _loc3_.y;
               this.var_2495 = _loc3_.z;
               this.var_2492 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_172 != param1.getUpdateID())
         {
            ...
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_892));
            if(_loc4_ != this.var_1170)
            {
               this.var_1170 = _loc4_;
               this.var_2494 = this.var_1170 & 255;
               this.var_2491 = this.var_1170 >> 8 & 255;
               this.var_2493 = this.var_1170 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1135));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_172 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_350);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_298);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_315);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_932));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_890));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_722));
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         {
            _loc5_ = this.var_143[_loc4_] as RoomPlane;
            if(_loc5_ != null)
            {
      ...
      {
         if(param1 != this.var_311["null"] || param2 != this.var_311["null"] || param3 != this.var_311["null"])
         {
            this.var_311["null"] = param1;
            this.var_311["null"] = param2;
            this.var_311["null"] = param3;
            this.var_369 = [];
            this.var_630 = [];
         }
      }
         ...
         while(_loc9_ < _loc6_.length)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_311[_loc12_.type]))
                  {
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1746;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_507.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         var _loc7_:int = 0;
         while(_loc7_ < this.var_143.length)
         {
            _loc3_ = this.var_143[_loc7_] as RoomPlane;
            if(_loc3_ != null)
            {
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_507.maskCount)
         {
            _loc10_ = this.var_507.getMaskType(_loc8_);
            _loc11_ = this.var_507.getMaskLocation(_loc8_);
            _loc12_ = this.var_507.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_143.length)
               {
                  _loc3_ = this.var_143[_loc13_] as RoomPlane;
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_129 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_240)
                              {
         ...
         while(_loc9_ < _loc4_.length)
         {
            ...
            {
               _loc3_ = this.var_143[_loc18_] as RoomPlane;
