         ...
         if(param1 is RoomObjectRoomAdUpdateMessage)
         {
            ...
            switch(_loc2_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_1086:
                  object.getModelController().setString(RoomObjectVariableEnum.const_550,"true");
                  _loc3_ = true;
                  break;
               case RoomObjectRoomAdUpdateMessage.const_1172:
                  object.getModelController().setString(RoomObjectVariableEnum.const_550,"error");
                  Logger.log("failed to load billboard image from url " + object.getModelController().getString(RoomObjectVariableEnum.const_757));
            }
            if(_loc3_)
            {
               object.setDirty();
         ...
         if(object != null)
         {
            ...
            if(_loc1_ != null)
            {
               ...
               if(_loc2_ != null && _loc2_.length >= 2)
               {
                  _loc3_ = _loc2_[0];
                  _loc4_ = _loc2_[1];
                  object.getModelController().setString(RoomObjectVariableEnum.const_757,_loc3_);
                  object.getModelController().setString(RoomObjectVariableEnum.FURNITURE_BILLBOARD_CLICK_URL,_loc4_);
                  object.getModelController().setString(RoomObjectVariableEnum.const_550,"loading");
