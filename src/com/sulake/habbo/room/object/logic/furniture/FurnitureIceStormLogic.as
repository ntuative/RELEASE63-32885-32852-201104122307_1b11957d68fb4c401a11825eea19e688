package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         {
            this.var_1660 = _loc2_;
            this.var_2762 = param1.extra;
            this.var_1256 = lastUpdateTime + _loc3_;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1256 > 0 && param1 >= this.var_1256)
         {
            this.var_1256 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_1660,String(this.var_1660),this.var_2762);
