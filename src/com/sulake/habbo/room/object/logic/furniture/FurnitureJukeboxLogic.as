package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureJukeboxLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_527,RoomObjectFurnitureActionEvent.const_472,RoomObjectFurnitureActionEvent.const_459,RoomObjectFurnitureActionEvent.const_594,RoomObjectWidgetRequestEvent.const_148];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(object.getModelController().getNumber(RoomObjectVariableEnum.const_860) == 1)
         {
            object.getModelController().setString(RoomWidgetInfostandExtraParamEnum.const_614,RoomWidgetInfostandExtraParamEnum.const_698);
            ...
            if(_loc4_ != this.var_2573)
            {
               this.var_2573 = _loc4_;
               if(_loc4_ == 1)
               {
