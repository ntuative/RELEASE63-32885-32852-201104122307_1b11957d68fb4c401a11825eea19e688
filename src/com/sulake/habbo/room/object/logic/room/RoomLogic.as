package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1526:uint = 16777215;
      
      private var var_1932:int = 255;
      
      private var var_1232:uint = 16777215;
      
      private var var_1931:int = 255;
      
      private var var_1233:int = 0;
      
      private var var_1933:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_539,RoomObjectMouseEvent.const_153];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1224,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_892,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_932,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_890,1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1233)
         {
            ...
            if(_loc2_ - this.var_1233 >= this.var_1933)
            {
               _loc3_ = this.var_1232;
               _loc4_ = this.var_1931;
               this.var_1233 = 0;
            }
            else
            {
               _loc7_ = this.var_1526 >> 16 & 255;
               _loc8_ = this.var_1526 >> 8 & 255;
               _loc9_ = this.var_1526 & 255;
               _loc10_ = this.var_1232 >> 16 & 255;
               _loc11_ = this.var_1232 >> 8 & 255;
               _loc12_ = this.var_1232 & 255;
               _loc13_ = (_loc2_ - this.var_1233) / this.var_1933;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1932 + (this.var_1931 - this.var_1932) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_892,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_907:
               param2.setString(RoomObjectVariableEnum.const_298,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_954:
               param2.setString(RoomObjectVariableEnum.const_350,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_928:
               param2.setString(RoomObjectVariableEnum.const_315,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_606:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_240)
               {
                  _loc5_ = "null";
               }
               this.var_507.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_861:
               _loc4_ = this.var_507.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_507.getXML();
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1071:
               param2.setNumber(RoomObjectVariableEnum.const_932,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1170:
               param2.setNumber(RoomObjectVariableEnum.const_890,_loc3_);
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1135,int(param1.bgOnly));
         this.var_1526 = this._color;
         this.var_1932 = this.var_1681;
         this.var_1232 = _loc3_;
         this.var_1931 = _loc4_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1592,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1674,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1608,_loc21_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_165 || _loc12_ == RoomPlaneData.const_289)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
