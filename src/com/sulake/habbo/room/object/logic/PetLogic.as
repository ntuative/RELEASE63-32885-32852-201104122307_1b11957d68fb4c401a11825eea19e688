   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(!this.var_2432)
         {
            ...
            if(param1 is RoomObjectAvatarSleepUpdateMessage)
            {
               ...
               _loc2_.setNumber(RoomObjectVariableEnum.const_395,Number(_loc7_.isSleeping));
               return;
            }
         }
         ...
         if(param1 is RoomObjectAvatarExperienceUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_866,Number(_loc9_.gainedExperience));
            return;
         }
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            _loc10_ = param1 as RoomObjectAvatarFigureUpdateMessage;
            _loc11_ = _loc2_.getString(RoomObjectVariableEnum.const_202);
            _loc2_.setString(RoomObjectVariableEnum.const_202,_loc10_.figure);
            _loc2_.setString(RoomObjectVariableEnum.const_1738,_loc10_.race);
            _loc2_.setNumber(RoomObjectVariableEnum.const_674,this.getPaletteIndex(_loc10_.figure));
            return;
         }
      }
      ...
      private function debugMouseEvent(param1:RoomSpriteMouseEvent) : void
      {
         ...
         if(!param1.altKey && !param1.ctrlKey)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_210,_loc3_ + this.var_945);
         }
         else if(param1.altKey && !param1.ctrlKey)
         {
            ++this.var_1759;
            _loc2_.setNumber(RoomObjectVariableEnum.const_225,this.var_1759);
            _loc2_.setNumber(RoomObjectVariableEnum.const_137,NaN);
         }
         else if(param1.ctrlKey && !param1.altKey)
         {
            ++this.var_1758;
            _loc2_.setNumber(RoomObjectVariableEnum.const_137,this.var_1758);
         }
         else
         {
            this.var_945 += 45;
