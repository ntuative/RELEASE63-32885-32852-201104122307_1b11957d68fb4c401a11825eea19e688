package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private var var_1266:Number = 0.0;
      ...
      public function initializeTileMap(param1:int, param2:int) : Boolean
      {
         ...
         this.var_263 = param1;
         this._height = param2;
         this.var_550 = this.var_263;
         this.var_548 = -1;
         this.var_549 = this._height;
         this.var_551 = -1;
         return true;
      }
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         var _loc8_:int = 0;
         if(param1 >= 0 && param1 < this.var_263 && param2 >= 0 && param2 < this._height)
         {
            ...
            if(param3 >= 0)
            {
               ...
               if(param2 < this.var_549)
               {
                  this.var_549 = param2;
               }
               if(param2 > this.var_551)
               {
                  this.var_551 = param2;
               }
            }
            ...
            {
               if(param1 == this.var_550 || param1 == this.var_548)
               {
                  _loc5_ = false;
                  _loc6_ = this.var_549;
                  while(_loc6_ < this.var_551)
                  {
               ...
               if(param2 == this.var_549 || param2 == this.var_551)
               {
                  _loc7_ = false;
                  _loc8_ = this.var_550;
                  while(_loc8_ < this.var_548)
                  {
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         this.var_911 = getFloorHeight(this.var_170);
         if(!param1)
         {
      ...
      private function addWall(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Boolean, param6:Boolean, param7:Boolean) : void
      {
         ...
         var _loc10_:Vector3d = Vector3d.product(_loc9_,1 / _loc9_.length * -this.var_1266);
         this.addPlane(RoomPlaneData.const_165,Vector3d.sum(param1,param3),param2,_loc10_,[_loc9_,param4]);
         if(param5)
         {
            this.addPlane(RoomPlaneData.const_165,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + this.var_142) / param3.length),_loc10_,[_loc9_,param4]);
         }
         if(param6)
         {
            this.addPlane(RoomPlaneData.const_165,Vector3d.sum(param1,Vector3d.product(param3,-this.var_142 / param3.length)),Vector3d.product(param3,(param3.length + this.var_142) / param3.length),_loc10_,[_loc9_,param4]);
            if(param7)
            {
               _loc11_ = Vector3d.product(param2,this.var_1266 / param2.length);
      ...
      private function addFloor(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Number, param9:Number, param10:Number, param11:Number) : void
      {
         ...
         if(_loc12_)
         {
            ...
            if(param6)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_197,_loc13_,new Vector3d(0,0,-this.var_142),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_197,_loc13_,new Vector3d(0,0,-this.var_142),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_197,_loc13_,new Vector3d(0,0,-this.var_142),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_197,_loc13_,new Vector3d(0,0,-this.var_142),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
      ...
      public function getPlaneLocation(param1:int) : IVector3d
      {
         ...
         var _loc2_:RoomPlaneData = this.var_143[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
            return _loc2_.loc;
         }
      ...
      public function getPlaneType(param1:int) : int
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return RoomPlaneData.const_1112;
         }
         var _loc2_:RoomPlaneData = this.var_143[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
      ...
      public function getPlaneMaskLeftSideLoc(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:RoomPlaneData = this.var_143[param1] as RoomPlaneData;
         if(_loc3_ != null)
         {
