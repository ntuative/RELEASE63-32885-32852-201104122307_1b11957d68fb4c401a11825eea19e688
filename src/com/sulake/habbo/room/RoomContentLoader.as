package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      private static const const_357:String = "RCL_PUBLICROOM_";
      
      private static const const_1812:int = 0;
      
      private static const const_1012:int = 1;
      ...
      private static const const_639:String = "pet_place_holder";
      ...
      private static const const_1011:String = "selection_arrow";
      ...
      public function RoomContentLoader()
      {
         ...
         this.var_2699 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
      ...
      {
         if(this._state >= const_1012)
         {
            return;
         }
         this._stateEvents = param1;
         this.var_2697 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2696 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_2698 = param2.getKey("public.room.dynamic.download.url","");
         this._publicRoomLoadNameTemplate = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         this._state = const_1012;
         this.initFurnitureData();
      }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc2_.type == "s")
            {
               this.var_450.add(_loc3_,_loc4_);
            ...
            else if(_loc2_.type == "i")
            {
               ...
               this.var_664.add(_loc3_,_loc4_);
               if(this._wallItems[_loc7_] == null)
               {
                  this._wallItems[_loc7_] = 1;
               }
            }
            _loc8_ = this.var_665.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_665.remove(_loc7_);
               this.var_665.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(this.var_531 != null)
         {
            this.var_531.remove(param1);
            this.var_531.add(param1,param2);
         }
         if(this.var_532 != null)
         {
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         {
            return RoomObjectCategoryEnum.const_332;
         }
         return RoomObjectCategoryEnum.const_171;
      }
      ...
      {
         return [const_444,const_640,const_639,const_641,TILE_CURSOR,const_1011];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_450.getValue(param1) as String;
         return this.getObjectType(_loc2_);
      }
      
      public function getWallItemType(param1:int, param2:String = null) : String
      {
         var _loc3_:String = this.var_664.getValue(param1) as String;
      ...
      {
         var _loc2_:String = this.var_664.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      ...
      {
         if(this.var_206 != null && this.var_206.hasWorldType(const_357 + param1))
         {
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_238 || param1 == RoomObjectVisualizationEnum.const_72 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_27 || _loc2_ == RoomObjectCategoryEnum.const_26)
         {
            ...
            return int(this.var_665.getValue(param1));
         }
         return 0;
      }
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               while(_loc9_ < _loc7_.length)
               {
                  ...
                  _loc8_.push(this.var_2698 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_393,_loc4_);
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            this.var_206 = this.var_1513.getValue(param1) as PublicRoomData;
         }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2699.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1661);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            ...
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_393,_loc5_);
         }
         else
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_502,_loc5_);
         }
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_509.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         {
            _loc6_ = _loc3_[_loc5_];
            _loc7_ = const_357 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      {
         if(this.getObjectCategory(const_357 + param1) == RoomObjectCategoryEnum.const_82)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_206.getWorldHeightScale(const_357 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_206 != null)
         {
            return this.var_206.getWorldScale(const_357 + param1);
         }
         return 32;
      }
