package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_2199:FriendListLookAndFeel;
      
      private var var_442:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1635:OpenedToWebPopup;
      ...
      private var var_1634:AvatarSearchResults;
      ...
      {
         this.var_2199 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_103 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1634 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_593.stop();
            this.var_593.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_593 = null;
         }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1635 = new OpenedToWebPopup(this);
         }
         this.var_1635.show(x,y);
      }
      ...
      public function openFriendList() : void
      {
         ...
         var _loc1_:FriendListTab = this.tabs.findTab(FriendListTab.const_104);
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         this.var_157.events.dispatchEvent(_loc1_);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_312,HabboWindowStyle.const_44,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1091.createAvatarImage(param1,AvatarScaleType.const_88,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         this.var_157 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_347 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_103.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_103.addCategory(new FriendCategory(FriendCategory.const_1045,this.getText("friendlist.friends")));
         this.var_103.addCategory(new FriendCategory(FriendCategory.const_421,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_103.addFriend(new Friend(_loc4_));
         }
         this.var_442 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_593)
         {
            this.var_593 = new Timer(120000);
            this.var_593.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_593.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this.var_157.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_123,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_103.findCategory(FriendCategory.const_421);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_442.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_442.findTab(FriendListTab.const_100).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_442.findTab(FriendListTab.const_100);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1634.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_442.findTab(FriendListTab.const_100);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_715 || !this.var_347)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_715.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_46))
         {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ != null && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face != null)
               {
                  _loc4_ = _loc3_.view.getChildByName(const_181) as IBitmapWrapperWindow;
