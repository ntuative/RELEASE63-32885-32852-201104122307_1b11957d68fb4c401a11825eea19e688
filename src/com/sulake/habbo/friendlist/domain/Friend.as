package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1850:int = "F".charCodeAt(0);
      
      public static const const_1885:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_914 = param1.gender;
         this.var_738 = param1.online;
         this.var_1678 = param1.followingAllowed && param1.online;
         this.var_608 = param1.figure;
         this.var_1679 = param1.motto;
         this.var_1677 = param1.lastAccess;
         this.var_1507 = param1.categoryId;
