package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      private var var_769:ITextFieldWindow;
      ...
      {
         this.var_769 = ITextFieldWindow(param1.findChildByName("search_str"));
         this.var_769.procedure = this.onSearchInput;
         this.var_769.addEventListener(WindowKeyboardEvent.const_177,this.onSearchStrInput);
      ...
      private function onSearchEntry(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_691.setData(_loc3_.isAvatarOnline,_loc3_.avatarName,_loc3_.avatarMotto,_loc3_.avatarFigure,_loc3_.lastOnlineDate,_loc3_.realName);
            this.var_691.showPopup(this._friendList.view.mainWindow,IWindowContainer(param2));
         }
      ...
      private function onSearchStrInput(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc4_ = 25;
            _loc5_ = this.var_769.text;
            if(_loc5_.length > _loc4_)
            {
               this.var_769.text = _loc5_.substring(0,_loc4_);
            }
         }
      }
