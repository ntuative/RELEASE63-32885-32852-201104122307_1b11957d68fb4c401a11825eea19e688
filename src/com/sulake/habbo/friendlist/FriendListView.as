package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1798:String = "noconvinfo";
      
      private static const const_1797:String = "messageinput";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1448:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1448 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this._friendList.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_57,HabboToolbarIconEnum.FRIENDLIST,this.var_16));
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_1027 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_257 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_1448.prepare(this.var_1027);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_1182,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1084,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_672,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_814,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_672,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_814,true);
         this.var_16.findChildByName("open_edit_ctgs_but").procedure = this.method_7;
         this.var_1449 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1449.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1799 == -1 ? 0 : int(this.var_16.height - this.var_1799);
         var _loc4_:int = this.var_1800 == -1 ? 0 : int(this.var_16.width - this.var_1800);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1243,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_672,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1182,false);
         ...
         this.var_1799 = this.var_16.height;
         this.var_1800 = this.var_16.width;
