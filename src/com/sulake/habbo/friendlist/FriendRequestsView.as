package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1796:String = "no_reqs_info";
      ...
      private var var_1796:IContainerButtonWindow;
      
      private var var_1795:IContainerButtonWindow;
      ...
      {
         this.var_1796 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1795 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1795.procedure = this.onDismissAllButtonClick;
         this.var_1796.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_362)
         {
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_362;
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_362 && _loc4_.state != FriendRequest.const_398)
            {
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in this._friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_362 && _loc4_.state != FriendRequest.const_398)
            {
               ...
               _loc4_.state = FriendRequest.const_362;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1796,_loc1_);
         this.setEnabled(this.var_1795,_loc1_);
      }
