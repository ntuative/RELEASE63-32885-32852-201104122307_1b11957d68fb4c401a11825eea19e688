package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         this.var_1660 = param1.nextState;
         this.var_1363 = param1.loop;
         if(param1.background != null)
         {
            this.var_719 = this.getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         if(param6 != null)
         {
            this.var_905[this._frame] = param6.clone();
         }
      ...
      {
         if(this.var_1363 == true || this.var_904 == 0)
         {
      ...
      {
         return this.var_1363 == false && this.var_904 == 1 && this.var_1660 != this._state;
      }
      ...
      private function updateAssetInWindow(param1:IBitmapWrapperWindow) : void
      {
         ...
         {
            _loc2_ = this.var_905[this._frame];
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         {
            _loc3_ = new BitmapData(Math.max(param2.width,this.var_719.width),Math.max(param2.height,this.var_719.height),true,0);
            _loc4_ = _loc3_.height - this.var_719.rect.height;
            _loc3_.copyPixels(this.var_719,this.var_719.rect,new Point(0,_loc4_),null,null,true);
