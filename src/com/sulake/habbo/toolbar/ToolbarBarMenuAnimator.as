package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_216:Boolean = true;
      
      private static const const_1284:Number = 25;
      
      private static const const_1453:Number = 90;
      ...
      private var var_1353:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_591 = new Object();
         this.var_590 = new Array();
         this.var_589 = new Array();
         super();
         this._windowManager = param1;
         this.var_1353 = param2;
         this.var_713 = new Timer(const_1284);
         this.var_713.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      public function method_1(param1:ToolbarIcon, param2:String, param3:IWindowContainer, param4:String, param5:Number, param6:String, param7:Array = null) : void
      {
         if(param3 == null)
         {
            return;
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_344[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_966 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_966 || param1.desktop.height - param1.y < const_1285;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1353.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            this.var_344.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Point = this.var_1353.getIconLoc(param1.iconId);
      ...
      {
         return this.var_590[this.var_589.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_589[this.var_590.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_589.indexOf(param2);
         if(_loc3_ > -1)
         {
            this.var_589.splice(_loc3_,1);
            this.var_590.splice(_loc3_,1);
         }
         this.var_590.push(param1.name);
         this.var_589.push(param2);
         param1.addEventListener(WindowEvent.const_260,this.windowEventListener);
         param1.addEventListener(WindowEvent.const_187,this.windowEventListener);
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(this.var_591[_loc3_] == null)
            {
               this.var_591[_loc3_] = new Array();
            }
            if(this.var_591[_loc3_].indexOf(param1) < 0)
            {
               this.var_591[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      public function removeItem(param1:String) : void
      {
         if(this.var_344.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               this.var_344.splice(this.var_344.indexOf(param1),1);
            }
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(this.var_590[_loc2_] == param1.window.name)
            {
               _loc3_ = this.var_589[_loc2_];
               if(this.var_591[_loc3_] != null)
               {
                  _loc4_ = 0;
                  while(_loc4_ < this.var_591[_loc3_].length)
                  {
                     this.repositionWindow(this.var_591[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         var _loc7_:int = 0;
         while(_loc7_ < this.var_344.length)
         {
            _loc2_ = this._itemList[this.var_344[_loc7_]];
            if(_loc2_.active)
            {
