package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1462:LogoutController;
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_1462 = new LogoutController(this._windowManager,this._assetLibrary,events);
         }
         if(this._view == null)
         {
            return;
         }
         events.addEventListener(HabboToolbarSetIconEvent.const_123,this.onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_1120,this.onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_169,this.onRemoveToolbarIconEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_615,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1102,this.onDisplayWindowEvent);
      ...
      private function onAnimateWindowEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         if(this._state && this._view != null)
         {
            if(param1.type == HabboToolbarShowMenuEvent.const_57)
            {
               ...
               {
                  this._view.method_1(param1.menuId,param1.window);
               }
               else
               {
                  this._view.method_1(param1.menuId,param1.window,new Point(param1.window.x,param1.window.y));
               }
            }
            else
            {
