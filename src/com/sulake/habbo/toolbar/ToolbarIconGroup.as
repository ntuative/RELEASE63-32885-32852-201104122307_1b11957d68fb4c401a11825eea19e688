package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = this.var_2765.elements("menu");
      ...
      {
         var _loc3_:* = null;
         var _loc2_:int = this.var_829.indexOf(param1);
         if(_loc2_ > -1)
         {
            _loc3_ = this.getIconById(param1);
            if(_loc3_ != null)
      ...
      {
         return this.var_829.indexOf(param1) > -1;
      }
      ...
      private function alignItems() : void
      {
         ...
         {
            _loc2_ = this.var_829.indexOf(this.var_1554[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = this.var_326[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(this.var_1262 + _loc3_);
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return this.var_326[this.var_829.indexOf(param1)];
      }
