package com.sulake.habbo.toolbar
{
   ...
   public class LogoutController
   {
      ...
      private const const_589:int = 46;
      
      private const const_546:int = 3;
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_546;
         _loc3_.y = this.const_589;
         return _loc3_;
      }
      ...
      private function showConfirmation() : void
      {
         if(!this.var_652)
         {
            this.var_652 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
         }
      }
