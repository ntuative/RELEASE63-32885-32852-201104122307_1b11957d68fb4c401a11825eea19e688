package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_567:int = 4;
      
      private static const name_3:int = 0;
      
      private static const const_612:int = 1;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar, param6:HabboNotificationItem)
      {
         ...
         if(_loc8_ != null)
         {
            this.var_2003 = this._window.height - _loc8_.rectangle.bottom;
         }
         else
         {
            this.var_2003 = 15;
      ...
      {
         if(param1.badgeId != this.var_219.style.iconSrc)
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_612:
               ...
               _loc2_ = Number(this.var_1274) / Number(this.var_466["time_fade_in"]);
               if(this.var_1274 > int(this.var_466["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1029:
               ...
               if(this.var_1564 > int(this.var_466["time_display"]) && !this.var_2001)
               {
                  this.startFadeOut();
               }
               break;
            case const_1030:
               ...
               _loc3_ = 1 - Number(this.var_1273) / Number(this.var_466["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1273 > int(this.var_466["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_2003;
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         var _loc3_:int = this.var_157.orientation == "TOP" ? int(const_446) : 0;
         var _loc4_:int = this.var_157.orientation == "BOTTOM" ? int(_loc2_.height - const_446) : int(_loc2_.height);
         var _loc5_:int = this.var_157.orientation == "LEFT" ? int(const_446) : 0;
         var _loc6_:int = this.var_157.orientation == "RIGHT" ? int(_loc2_.width - const_446) : int(_loc2_.width);
         if(this.var_466["position_horizontal_follow_toolbar"] == "true" && (this.var_157.orientation != "TOP" && this.var_157.orientation != "BOTTOM"))
         {
            if(this.var_157.orientation == "LEFT")
            {
               this._window.x = _loc5_ + const_567;
            }
            else
            {
               this._window.x = _loc6_ - this._window.width - const_567;
            }
         }
         else if(this.var_466["position_horizontal"] == "left")
         {
            this._window.x = _loc5_ + const_567;
         }
         else
         ...
         if(this.var_466["position_vertical_follow_toolbar"] == "true" && (this.var_157.orientation != "RIGHT" && this.var_157.orientation != "LEFT"))
         {
            if(this.var_157.orientation == "TOP")
            {
               this._window.y = _loc3_ + this.var_839;
            }
            else
            {
               this._window.y = _loc4_ - this._window.height - this.var_839;
            }
         }
         else if(this.var_466["position_vertical"] == "top")
         {
            this._window.y = _loc3_ + this.var_839;
         }
         else
      ...
      private function adjustBlend(param1:Number) : void
      {
         ...
         this._window.blend = this.var_840;
      }
   }
}
