package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1348:String = "pixelbalance";
      
      private static const const_1345:String = "badges";
      
      private static const const_1350:String = "selectbadge";
      
      private static const const_1349:String = "inventory";
      
      private static const const_1343:String = "selectfurni";
      
      private static const const_1344:String = "credits";
      
      private static const const_1346:String = "friendlist";
      
      private static const const_1347:String = "pet_inventory";
      ...
      private var var_503:HabboNotificationViewManager;
      ...
      private var var_948:ClubGiftNotification;
      
      private var var_947:ClubEndingNotification;
      
      private var var_949:ClubPromoNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_950);
         }
         var _loc6_:Map = this.var_950["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_950["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
         ...
         this.var_1159.push(_loc8_);
         return this.var_1159.length;
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = this.var_1159.splice(0,1);
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_762.events.addEventListener(HabboToolbarEvent.const_68,this.onHabboToolbarEvent);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_68)
         {
            ...
            this.var_503 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_950["styles"],this.var_950["view"],this.var_762);
            ...
            registerUpdateReceiver(this.var_503,1);
            registerUpdateReceiver(this,2);
            this.var_424.events.addEventListener(BadgeImageReadyEvent.const_155,this.onBadgeImage);
            this.var_762.events.addEventListener(HabboToolbarEvent.const_457,this.onToolbarRepositionEvent);
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1423[_loc2_.badgeID] = new AchievementNotification(_loc2_.badgeID,_loc2_.achievementID,_loc2_.level,_loc2_.points,_loc2_.levelRewardPoints,_loc2_.levelRewardPointType,_loc2_.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_424);
      }
      ...
      function onAchievementShareId(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:AchievementNotification = this.var_1423[_loc2_.badgeID] as AchievementNotification;
         delete this.var_1423[_loc2_.badgeID];
         if(_loc3_)
         {
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_424.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1049,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1049,null);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1600,null);
         }
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_495.createAvatarImage(param2,AvatarScaleType.const_52);
         if(_loc7_ != null)
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               ...
               else if(_loc6_.productType == CatalogPageMessageProductData.const_71)
               {
               ...
               if(_loc8_)
               {
                  this.addItem(_loc8_.value,NotificationType.const_1523,_loc5_);
               }
            }
         }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1097)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1736,null);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1679)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               this.var_947 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,assets,this._windowManager,this._catalog,this._localization);
            }
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_949 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_503.isSpaceAvailable() && this.var_1159.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_503.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1345:
               ...
               {
                  this._inventory.toggleInventoryPage(InventoryCategory.const_342);
               }
               break;
            case const_1350:
               break;
      ...
      private function onBadgeImage(param1:BadgeImageReadyEvent) : void
      {
         ...
         {
            this.var_503.replaceIcon(param1);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1235,_loc4_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1235,_loc5_);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_495.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_52);
            if(_loc6_ != null)
            {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2439)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_1074,null);
            this.var_2439 = true;
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_948 && this.var_948.visible)
         {
            return;
         }
         this.var_948 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_1074,_loc6_);
      }
   }
}
