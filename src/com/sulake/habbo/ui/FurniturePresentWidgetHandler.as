package com.sulake.habbo.ui
{
   ...
   public class FurniturePresentWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_751,RoomWidgetPresentOpenMessage.const_175];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_751:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = _loc5_.getNumber(RoomObjectVariableEnum.const_287);
            ...
            case RoomWidgetPresentOpenMessage.const_175:
               ...
               if(_loc4_.objectId != this.var_352)
               {
                  return null;
               }
      ...
      {
         return [RoomSessionPresentEvent.const_331];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         if(this._container != null && this._container.events != null && param1 != null)
         {
            switch(param1.type)
            {
               case RoomSessionPresentEvent.const_331:
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     else if(_loc2_.itemType == ProductTypeEnum.const_71)
                     {
                     ...
                     switch(_loc2_.itemType)
                     {
                        case ProductTypeEnum.const_71:
                           ...
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_581,0,this._container.localization.getKey("inventory.furni.item.floor.name"),false,null);
                           }
                           ...
                           {
                              if(_loc3_ != null && _loc3_.name == const_1311)
                              {
                                 break;
                              }
                        ...
                        case ProductTypeEnum.const_296:
                           _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_565,0,this._container.localization.getKey("widget.furni.present.hc"),false,null);
                           break;
                        default:
