package com.sulake.habbo.ui
{
   ...
   public class PlayListEditorWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1494:IMessageEvent;
      
      private var var_1860:IMessageEvent;
      
      private var var_1861:IMessageEvent;
      ...
      {
         this.var_1494 = new FurniListUpdateEvent(this.onFurniListUpdated);
         this.var_1860 = new FurniListRemoveEvent(this.onFurniListUpdated);
         this.var_1861 = new FurniListInsertEvent(this.onFurniListUpdated);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1494);
         this._connection.addMessageEvent(this.var_1860);
         this._connection.addMessageEvent(this.var_1861);
      }
      ...
      public function dispose() : void
      {
         ...
         this._connection.removeMessageEvent(this.var_1494);
         this._connection.removeMessageEvent(this.var_1860);
         this._connection.removeMessageEvent(this.var_1861);
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_803,RoomWidgetPlayListModificationMessage.const_821,RoomWidgetPlayListModificationMessage.const_869,RoomWidgetPlayListPlayStateMessage.const_948,RoomWidgetPlayListUserActionMessage.const_854];
      }
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_803:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc7_)
                  {
                     _loc8_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_848,_loc2_.id);
                     this._container.events.dispatchEvent(_loc8_);
                  }
               }
               break;
            case RoomWidgetPlayListModificationMessage.const_821:
               ...
               break;
            case RoomWidgetPlayListModificationMessage.const_869:
               ...
               break;
            case RoomWidgetPlayListPlayStateMessage.const_948:
               ...
               break;
            case RoomWidgetPlayListUserActionMessage.const_854:
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineSoundMachineEvent.const_245:
               ...
               _loc3_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_813,_loc2_.objectId);
      ...
      private function onFurniListUpdated(param1:IMessageEvent) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_780,-1));
            }
         }
      }
   }
