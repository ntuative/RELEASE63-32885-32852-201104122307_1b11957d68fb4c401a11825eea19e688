package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_952,RoomWidgetEcotronBoxOpenMessage.const_690,RoomWidgetEcotronBoxOpenedMessage.const_1609];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_952:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_690:
