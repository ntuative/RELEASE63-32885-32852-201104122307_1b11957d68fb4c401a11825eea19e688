package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1359:String = "room_view";
      
      private const const_2077:String = "room_widget";
      
      private var var_48:IWindowContainer;
      
      private var var_775:int = 50;
      
      private var var_2915:XML = null;
      ...
      public function addWidgetWindow(param1:String, param2:IWindow) : Boolean
      {
         ...
         {
            if(String(_loc3_[_loc5_]).indexOf(this.const_2077) == 0)
            {
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = this.var_48.getChildByTag(this.const_1359) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         {
            case "LEFT":
               _loc2_.x = this.var_775;
               _loc2_.width = this.var_48.desktop.width - this.var_775;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.y = this.var_775;
               _loc2_.height = this.var_48.desktop.height - this.var_775;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = this.var_48.desktop.width;
      ...
      public function get method_5() : Rectangle
      {
         if(this.var_48 == null)
         {
            return null;
         }
         var _loc1_:IWindowContainer = this.var_48.findChildByTag(this.const_1359) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
