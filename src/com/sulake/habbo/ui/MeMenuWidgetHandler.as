   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_725,this.onAvatarEffectsChanged);
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_747,this.onHabboClubSubscriptionChanged);
            }
            if(this.var_157 && !this.var_157.disposed && this.var_157.events)
            {
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_590,this.onHelpTutorialEvent);
         ...
         {
            this._inventory.events.addEventListener(HabboInventoryEffectsEvent.const_725,this.onAvatarEffectsChanged);
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_747,this.onHabboClubSubscriptionChanged);
         }
         ...
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_590,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this.var_157 != null)
         {
            _loc5_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1120,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null)
            {
               _loc5_.bitmapData = _loc1_;
            }
            this.var_157.events.dispatchEvent(_loc5_);
         }
      }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetDanceMessage.const_865);
         ...
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_842);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_425);
         _loc1_.push(RoomWidgetStopEffectMessage.const_959);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1588);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1151);
         _loc1_.push(RoomWidgetToolbarMessage.const_941);
         _loc1_.push(RoomWidgetToolbarMessage.const_921);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_392);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1713);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1260);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_739);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_871);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_759);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1531);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_843);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_711);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_824);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_871:
            ...
            case RoomWidgetWaveMessage.const_715:
               ...
               break;
            case RoomWidgetDanceMessage.const_865:
               if(this._container != null && this._container.roomSession != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_425:
               ...
               break;
            case RoomWidgetOpenInventoryMessage.const_842:
            ...
            case RoomWidgetStopEffectMessage.const_959:
               ...
               break;
            case RoomWidgetSetToolbarIconMessage.const_1108:
               _loc4_ = param1 as RoomWidgetSetToolbarIconMessage;
               switch(_loc4_.widgetType)
               {
                  case RoomWidgetSetToolbarIconMessage.const_1502:
                     break;
                  default:
            ...
            case RoomWidgetNavigateToRoomMessage.const_1151:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_739:
               if(this._container != null)
               {
            ...
            case RoomWidgetToolbarMessage.const_941:
               ...
               if(this.var_157)
               {
                  this.var_157.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_57,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(this._inventory != null)
                  {
                     _loc12_ = false;
               ...
               break;
            case RoomWidgetToolbarMessage.const_921:
               ...
               {
                  this.var_157.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_615,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            ...
            case RoomWidgetGetSettingsMessage.const_759:
               ...
               break;
            case RoomWidgetStoreSettingsMessage.const_843:
            ...
            case RoomWidgetStoreSettingsMessage.const_711:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_434,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_824:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_756));
      }
