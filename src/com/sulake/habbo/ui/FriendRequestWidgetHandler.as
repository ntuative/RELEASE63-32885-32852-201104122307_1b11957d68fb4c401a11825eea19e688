package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_663);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_669);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_874);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_663:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_669:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_874:
