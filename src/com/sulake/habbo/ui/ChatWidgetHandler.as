package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_820:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_456 != null)
         {
            ...
            {
               _loc2_ = this.var_456.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_591,RoomWidgetChatSelectAvatarMessage.const_762];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_591:
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_762:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           {
                              _loc13_ = this.var_456.getValue(_loc16_) as BitmapData;
                           }
                           ...
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    ...
                                    {
                                       this.var_456.add(_loc16_,_loc13_);
                                    }
                                 }
                              }
                           }
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_820 == null)
            {
               ...
               this.var_538.y = 0;
               this.var_538.z = 0;
               this.var_820 = _loc4_.getScreenPoint(this.var_538);
            ...
            this.var_538.y = 0;
            this.var_538.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_538);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_820.x || _loc8_.y != this.var_820.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_820,_loc5_));
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         if(this.var_456)
         {
            _loc2_ = this.var_456.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1237.push(_loc2_);
            }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1936.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1936.remove(param1);
         if(_loc3_ != null)
         {
