package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_466:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_150.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_150,HabboWindowStyle.const_44,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1777,"/");
         if(_loc5_ != null)
         {
         ...
         if(_loc8_)
         {
            ...
            {
               if(this.var_150.habboConfiguration.getKey("use.sso","false") == "true")
               {
                  _loc8_.select();
               }
            }
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1777,"/");
         ...
         {
            dispatchEvent(new Event(const_466));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_132.removeEventListener(SSOTicket.const_408,this.onParsedTicketSuccess);
            this.var_132.removeEventListener(SSOTicket.const_291,this.onParsedTicketFailure);
            this.var_132 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_132 = new SSOTicket(this.var_150.assets,_loc3_,_loc2_,param1);
         this.var_132.addEventListener(SSOTicket.const_408,this.onParsedTicketSuccess);
         this.var_132.addEventListener(SSOTicket.const_291,this.onParsedTicketFailure);
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         this.var_150.flashClientUrl = this.var_132.flashClientUrl;
         this.var_150.ssoTicket = this.var_132.ticket;
         this.var_132.removeEventListener(SSOTicket.const_408,this.onParsedTicketSuccess);
         this.var_132.removeEventListener(SSOTicket.const_291,this.onParsedTicketFailure);
         this.var_132 = null;
         dispatchEvent(new Event(const_466));
