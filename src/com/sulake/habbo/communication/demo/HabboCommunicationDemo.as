package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2660:PseudoRandom;
      ...
      private const const_1777:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_656 = param1;
            this.var_57.initConnection(HabboConnectionType.const_274);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionEvent.const_93,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            this.var_57.addHabboConnectionMessageEvent(new SessionParamsMessageEvent(this.method_9));
      ...
      {
         if(this.var_57 && this.var_164 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_232 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         var _loc1_:String = this.var_164.getKey("client.hotel_view.image");
         var _loc2_:String = this.var_164.getKey("image.library.url");
         if(_loc1_ != null && _loc2_ != null)
         {
            this.var_232.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this.var_164.getKey("use.sso.ticket") == "1";
         this.var_656 = this.var_164.getKey("sso.ticket",null);
         this.var_1896 = this.var_164.getKey("flash.client.url","");
         this.var_2662 = this.var_164.getKey("external.variables.txt","");
         if(this.var_232 == null)
         {
            this.var_232 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_57.mode = HabboConnectionType.const_95;
            if(this.var_656)
            {
               this.var_57.initConnection(HabboConnectionType.const_274);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_466,this.onInitConnection);
            }
         }
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_678);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2660 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_57.mode)
         {
            case HabboConnectionType.const_95:
               ...
               this.var_232.loadBannerImage(_loc7_ + "?token=" + this.var_1505,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1081:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1606:
               this.var_998 = this.generateRandomHexString(30);
               this.var_526 = new DiffieHellman(new BigInteger(this.var_164.getKey("connection.development.prime"),16),new BigInteger(this.var_164.getKey("connection.development.generator"),16));
               this.var_526.init(this.var_998);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2660);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1896,this.var_2662));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1777,"/");
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_276);
      }
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2661)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1505);
