package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1001:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1375:String = "sendAccessTokenToServer";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1375,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1374,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1001);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1001);
         }
      }
