   ...
   public class HabboGroupInfoManager
   {
      ...
      private function onHabboGroupBadges(param1:IMessageEvent) : void
      {
         ...
         while(_loc6_ < _loc3_.length)
         {
            ...
            if(this.var_271.getValue(_loc4_) != null)
            {
               this.var_271.remove(_loc4_);
            }
            this.var_271.add(_loc4_,_loc3_.getWithIndex(_loc6_));
            _loc6_++;
         }
      }
      ...
      private function onGroupDetails(param1:IMessageEvent) : void
      {
         ...
         _loc3_.badgeId = this.var_271.getValue(_loc2_.groupId);
      ...
      {
         return this.var_271.getValue(param1);
      }
