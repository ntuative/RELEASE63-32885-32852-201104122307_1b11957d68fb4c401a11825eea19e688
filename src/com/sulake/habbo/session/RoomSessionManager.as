package com.sulake.habbo.session
{
   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      private function initializeManager() : void
      {
         ...
         if(this.initialized && this.var_1849)
         {
            this.gotoRoom(this.var_2633,this.var_2635,this.var_1848);
            this.var_1849 = false;
            this.var_1848 = "";
         }
      }
         ...
         if(_loc4_ != null)
         {
            switch(param3)
            {
               case RoomSessionHandler.const_1089:
                  break;
               case RoomSessionHandler.const_1096:
                  break;
