package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1083:BitmapData = null;
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2134 = this._config.getKey("interstitial.enabled","false") == "true";
         ...
         this.var_1606 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_1606 > 0 && this.var_1604 >= this.var_1606)
         {
            return false;
         }
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1342 = _loc2_.imageUrl;
         this.var_2132 = _loc2_.clickUrl;
         this.var_1082 = getTimer();
         if(this.var_1342 != "")
         {
            _loc3_ = this.var_1342;
            ...
            this.var_217.start();
            _loc4_ = new URLRequest(this.var_1342);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_588,0,0,param1.bitmapData,this.var_2132));
            this.var_1082 = getTimer();
         }
         else
         {
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1341 = _loc2_.imageUrl;
         this.var_1605 = _loc2_.clickUrl;
         if(this.var_1341 != "" && this.var_1605 != "")
         {
            _loc3_ = this.var_1341;
            if(assets.hasAsset(_loc3_))
            {
               assets.removeAsset(assets.getAssetByName(_loc3_));
            }
            _loc4_ = new URLRequest(this.var_1341);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_450,0,0,_loc4_,_loc2_.assetName,this.var_1605,this.var_1081,this.var_1083));
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1083 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function loadImageAsset(param1:AdImageEvent) : void
      {
         ...
         var _loc3_:Array = this.var_579.getValue(_loc2_);
         if(_loc3_ == null)
         {
            _loc3_ = new Array();
      ...
      private function onBillboardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Bitmap = _loc2_.assetLoader.content as Bitmap;
         var _loc4_:Array = this.var_579.remove(_loc2_.assetName);
      ...
      private function dispatchImageAsset(param1:BitmapData, param2:AdImageEvent) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_726,param2.roomId,0,param1.clone(),param2.imageUrl,param2.clickUrl,null,null,param2.objectId));
         }
      }
      ...
      private function onBillboardImageLoadError(param1:AssetLoaderEvent) : void
      {
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_847,_loc5_.roomId,0,null,_loc5_.imageUrl,_loc5_.clickUrl,null,null,_loc5_.objectId));
         }
      }
   }
}
